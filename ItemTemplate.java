package l2r.gameserver.templates.item;
...
public abstract class ItemTemplate extends StatTemplate
{
	...
	public static final int ITEM_ID_DIVISION_POINTS = -800;
	public static final int ITEM_ID_ADENA = 57;
	public static final int FESTIVAL = 6673;
	
	/** Item ID Π΄Π»Ρ� Π·Π°ΠΌΠΊΠΎΠ²Ρ‹Ρ… ΠΊΠΎΡ€ΠΎΠ½ */
	...
	public static enum Grade
	{
		...
		/** ID Ρ�ΠΎΠΎΡ‚Π²ΠµΡ‚Ρ�Ρ‚Π²ΡƒΡ�Ρ‰ΠµΠ³ΠΎ Π³Ρ€ΠµΠΉΠ΄Ρƒ ΠΊΡ€ΠΈΡ�Ρ‚Π°Π»Π»Π° */
		public final int cry;
		/** ID Π³Ρ€ΠµΠΉΠ΄Π°, Π±ΠµΠ· ΡƒΡ‡ΠµΡ‚Π° ΡƒΡ€ΠΎΠ²Π½Ρ� S */
	...
	protected ItemTemplate(final StatsSet set)
	{
		...
		_fishingRodLevel = set.getInteger("fishingRodLevel", 0);
		_fishingRodDamage = set.getDouble("fishingRodDamage", 0.);
	...
	/**
	 * Π’ΠΎΠ·Π²Ρ€Π°Ρ‰Π°ΠµΡ‚ Π³ΠΎΡ‚ΠΎΠ²ΡƒΡ� Π΄Π»Ρ� ΠΎΡ‚ΠΎΠ±Ρ€Π°Π¶ΠµΠ½ΠΈΡ� Π² html Ρ�Ρ‚Ρ€ΠΎΠΊΡƒ Π²ΠΈΠ΄Π° <img src=icon.ΠΈΠΊΠΎΠ½ΠΊΠ° width=32 height=32>
	 */
	...
	/**
	 * Π�Π°Π³ΠΈΡ‡ΠµΡ�ΠΊΠ°Ρ� Π±Ρ€ΠΎΠ½Ρ� Π΄Π»Ρ� ΠΏΠµΡ‚ΠΎΠ²
	 */
	...
	/**
	 * Π�ΠΏΡ€ΠµΠ΄ΠµΠ»Ρ�ΠµΡ‚ ΠΏΡ€ΠΈΠ·Ρ€Π°Ρ‡Π½Ρ‹ΠΉ ΠΏΡ€ΠµΠ΄ΠΌΠµΡ‚ ΠΈΠ»ΠΈ Π½ΠµΡ‚
	 * @return true, ΠµΡ�Π»ΠΈ ΠΏΡ€ΠµΠ΄ΠΌΠµΡ‚ ΠΏΡ€ΠΈΠ·Ρ€Π°Ρ‡Π½Ρ‹ΠΉ
	 */
	...
	/**
	 * Π―Π²Π»Ρ�ΠµΡ‚Ρ�Ρ� Π»ΠΈ Π²ΠµΡ‰Ρ� Π°Π΄ΠµΠ½ΠΎΠΉ ΠΈΠ»ΠΈ ΠΊΠ°ΠΌΠ½ΠµΠΌ ΠΏΠµΡ‡Π°Ρ‚ΠΈ
	 */
	...
	{
		return (_itemId == 6360) || (_itemId == 6361) || (_itemId == 6362);
	}
	...
	{
		return isAttributeCrystal() || isAttributeJewel() || isAttributeEnergy() || isAttributeStone();
	}
	...
	public boolean isFlagEquiped()
	{
		return (_itemId == 13530) || (_itemId == 13531) || (_itemId == 13532) || (_itemId == 13533) || (_itemId == 13534) || (_itemId == 13535) || (_itemId == 13536) || (_itemId == 13537) || (_itemId == 13538);
	}
	...
	/**
	 * gradeCheck - ΠΈΡ�ΠΏΠΎΠ»Ρ�Π·ΠΎΠ²Π°Ρ‚Ρ� ΠΏΠΎΠΊΠ° Π½Πµ ΠΏΠµΡ€ΠµΠΏΠΈΡ�ΠµΡ‚Ρ�Ρ� Ρ�ΠΈΡ�Ρ‚ΠµΠΌΠ° Π·Π°Ρ‚ΠΎΡ‡ΠΊΠΈ
	 * @param gradeCheck
	 * @return
	 */
