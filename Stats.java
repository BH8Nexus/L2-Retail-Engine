...
public enum Stats
{
	...
	// Î â€�Î Â»Î¡ï¿½ Î¡ï¿½Î¡â€žÎ¡â€žÎ ÂµÎ ÎŠÎ¡â€šÎ ÎŽÎ Â² Î¡â€šÎ ÎˆÎ Î�Î Â° Seal of Limit
	...
	POWER_DEFENCE("pDef"),
	MAGIC_DEFENCE("mDef"),
	POWER_ATTACK("pAtk"), //FIXME TEST CODE
	MAGIC_ATTACK("mAtk"), //FIXME TEST CODE
	...
	CRITICAL_DAMAGE_POSITION("cAtkPosition", 0., Double.POSITIVE_INFINITY, 100.), // In retail there is such stat for focus death and focus power. Difference from normal crit is that its x0.5 effective in blows.
	...
	CRITICAL_RATE("rCrit", 0., Double.POSITIVE_INFINITY, 100.), // dynamic crit rate. Use it to MULTIPLE crit for 1.3, 1.5 etc. Sample: <add order="0x40" stat="rCrit" val="50" /> = (x1.5)
	CRITICAL_RATE_POSITION("rCritPosition", 0., Double.POSITIVE_INFINITY, 100.), // Same like cAtkPosition, also ignores critical rate cap of 500.
	MCRITICAL_RATE("mCritRate", 0., Double.POSITIVE_INFINITY, Config.ALT_BASE_MCRIT_RATE), // INFO: Its 10.0 in retail.
	MCRITICAL_DAMAGE("mCritDamage", 0., 10.0D, Config.ALT_BASE_MCRIT_DAMAGE), // 2.5),
	...
	POWER_ATTACK_RANGE("pAtkRange", 0., 1500./* Retail?: 1500. */),
	...
	SLOW_RESIST("slowResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY),
	...
	// Î ï¿½Î¡â€šÎ¡â‚¬Î Â°Î Â¶Î ÂµÎ Â½Î ÎˆÎ Âµ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½Î Â° Î¡ï¿½ Î¡ï¿½Î Â°Î Â½Î¡ï¿½Î ÎŽÎ ÎŒ. Î Â£Î¡â‚¬Î ÎŽÎ Â½ Î Î�Î ÎŽÎ Â»Î¡Æ’Î¡â€¡Î Â°Î ÂµÎ¡â€š Î¡â€šÎ ÎŽÎ Â»Î¡ï¿½Î ÎŠÎ ÎŽ Î Â°Î¡â€šÎ Â°Î ÎŠÎ¡Æ’Î¡ï¿½Î¡â€°Î ÎˆÎ Î‰.
	REFLECT_AND_BLOCK_DAMAGE_CHANCE("reflectAndBlockDam", 0., 100.), // Î â€˜Î Â»Î ÎˆÎ Â¶Î Â½Î ÎˆÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î Â±Î ÂµÎ Â· Î¡ï¿½Î ÎŠÎ ÎˆÎ Â»Î Â»Î ÎŽÎ Â²
	REFLECT_AND_BLOCK_PSKILL_DAMAGE_CHANCE("reflectAndBlockPSkillDam", 0., 100.), // Î â€˜Î Â»Î ÎˆÎ Â¶Î Â½Î ÎˆÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î¡ï¿½Î ÎŠÎ ÎˆÎ Â»Î Â»Î Â°Î ÎŒÎ Îˆ
	REFLECT_AND_BLOCK_MSKILL_DAMAGE_CHANCE("reflectAndBlockMSkillDam", 0., 100.), // Î â€ºÎ¡ï¿½Î Â±Î ÎŽÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î ÎŒÎ Â°Î Â³Î ÎˆÎ ÂµÎ Î‰
	
	// Î ï¿½Î¡â€šÎ¡â‚¬Î Â°Î Â¶Î ÂµÎ Â½Î ÎˆÎ Âµ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½Î Â° Î Â² Î Î�Î¡â‚¬Î ÎŽÎ¡â€ Î ÂµÎ Â½Î¡â€šÎ Â°Î¡â€¦. Î Â£Î¡â‚¬Î ÎŽÎ Â½ Î Î�Î ÎŽÎ Â»Î¡Æ’Î¡â€¡Î Â°Î ÂµÎ¡â€š Î Îˆ Î Â°Î¡â€šÎ Â°Î ÎŠÎ¡Æ’Î¡ï¿½Î¡â€°Î ÎˆÎ Î‰ Î Îˆ Î¡â€ Î ÂµÎ Â»Î¡ï¿½
	REFLECT_DAMAGE_PERCENT("reflectDam", 0., 100.), // Î â€˜Î Â»Î ÎˆÎ Â¶Î Â½Î ÎˆÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î Â±Î ÂµÎ Â· Î¡ï¿½Î ÎŠÎ ÎˆÎ Â»Î Â»Î ÎŽÎ Â²
	REFLECT_PSKILL_DAMAGE_PERCENT("reflectPSkillDam", 0., 100.), // Î â€˜Î Â»Î ÎˆÎ Â¶Î Â½Î ÎˆÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î¡ï¿½Î ÎŠÎ ÎˆÎ Â»Î Â»Î Â°Î ÎŒÎ Îˆ
	REFLECT_MSKILL_DAMAGE_PERCENT("reflectMSkillDam", 0., 100.), // Î â€ºÎ¡ï¿½Î Â±Î ÎŽÎ Î‰ Î¡Æ’Î¡â‚¬Î ÎŽÎ Â½ Î ÎŒÎ Â°Î Â³Î ÎˆÎ ÂµÎ Î‰
	...
	EXP("ExpMultiplier"),
	SP("SpMultiplier"),
	RATE_ADENA("adena_drop_multiplier"),
	RATE_ITEMS("items_drop_multiplier"),
	RATE_SPOIL("spoil_drop_multiplier"),
	REWARD_MULTIPLIER("DropMultiplier"),
	FISHING_MASTERY("fishingMastery"),
//	RATE_ADENA("rateAdena", 0., Double.POSITIVE_INFINITY, 1.0),
//	RATE_SPOIL("rateSpoil", 0., Double.POSITIVE_INFINITY, 1.0),
	
	// ----------------------------------------------------------
	// CUSTOM!!!!
	// ----------------------------------------------------------
	RUSH_WALK("rushWalk", 50, 1000), // MoveBackwardToLocation packet triggers rush effect and player moves instantaneously to the target location if the RushWalk doesnt exceed max range (1000)
	RUSH_ATTACK("rushAttack", 50, 1000),
	ADENA_MULTIPLIER("AdenaMultiplier"),
	INSTANT_JUMP_ATTACK("instantJumpAttack", 50, 1000); // Action packet triggers Shadow Step effect to teleport the player behind the enemy
