...
import l2r.commons.annotations.NotNull;
...
public final class ConfigHolder extends AbstractHolder
{
	...
	public static String getString(String name)
	{
		...
		if (string == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getString"));
		return string;
	}
	...
	public static File getFilePath(String name)
	{
		...
		if (filePath == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getFilePath"));
		return filePath;
	}
	...
	{
		if (name == null)
			throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "name", "l2r/gameserver/ConfigHolder", "getPattern"));
		final DynamicConfig value = getInstance().getOrLoad(name, Pattern.class);
		final Pattern pattern = value.getPattern();
		if (pattern == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getPattern"));
		return pattern;
	}
	...
	public static Location getLocation(String name)
	{
		...
		if (location == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getLocation"));
		return location;
	}
	...
	public static ChatType getChatType(String name)
	{
		...
		if (chatType == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getChatType"));
		return chatType;
	}
	...
	public static <E> E getEnum(String name, Class<E> type)
	{
		...
		if (classType == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getEnum"));
		return classType;
	}
	...
	public static ServerType getServerType(String name)
	{
		...
		if (serverType == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getServerType"));
		return serverType;
	}
	...
	public static AbnormalEffect getAbnormalEffect(String name)
	{
		...
		if (abnormalEffect == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getAbnormalEffect"));
	...
	public static int[][] getMultiIntArray(String name)
	{
		...
		if (multiIntArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMultiIntArray"));
	...
	public static long[][] getMultiLongArray(String name)
	{
		...
		if (multiLongArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMultiLongArray"));
	...
	public static double[][] getMultiDoubleArray(String name)
	{
		...
		if (multiDoubleArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMultiDoubleArray"));
	...
	public static String[][] getMultiStringArray(String name)
	{
		...
		if (multiStringArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMultiStringArray"));
	...
	public static <E> E[][] getMultiArray(String name, Class<E> primaryType)
	{
		...
		if (array2 == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMultiArray"));
		return array2;
	}
	...
	public static int[] getIntArray(String name)
	{
		...
		if (intArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getIntArray"));
		return intArray;
	}
	...
	public static long[] getLongArray(String name)
	{
		...
		if (longArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getLongArray"));
		return longArray;
	}
	...
	public static double[] getDoubleArray(String name)
	{
		...
		if (doubleArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getDoubleArray"));
		return doubleArray;
	}
	...
	public static boolean[] getBooleanArray(String name)
	{
		...
		if (booleanArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getBooleanArray"));
		return booleanArray;
	}
	...
	public static String[] getStringArray(String name)
	{
		...
		if (stringArray == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getStringArray"));
		return stringArray;
	}
	...
	public static <E> E[] getArray(String name, Class<E> primaryType)
	{
		...
		final E[] array2 = value.getClassType((Class<E[]>) array);
		if (array2 == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getArray"));
		return array2;
	}
	...
	public static <E, T> Map<E, T> getMap(String name, Class<E> firstType, Class<T> secondType)
	{
		...
		if (map == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMap"));
		return map;
	}
	...
	public static <E, T> Map.Entry<E, T> getMapEntry(String name, Class<E> firstType, Class<T> secondType)
	{
		...
		if (entry == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getMapEntry"));
		return entry;
	}
	...
	public static StatsSet getStatsSet(String name, Object... keysAndClasses)
	{
		...
		if (set == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getStatsSet"));
		return set;
	}
	...
	public static List<StatsSet> getStatsSetList(String name, Object... keysAndClasses)
	{
		...
		if (list == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getStatsSetList"));
		return list;
	}
	...
	public SelectorConfig getSelectorConfig()
	{
		...
		if (selectorConfig == null)
			throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getSelectorConfig"));
	...
	private DynamicConfig getOrLoad(String name, Class<?> type)
	{
		...
		if (convertedConfig != null)
		{
			...
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getOrLoad"));
	...
	@NotNull
	private DynamicConfig getOrLoadMap(String name, Class<?> firstType, final Class<?> secondType)
	{
		final String smallName = name.toLowerCase();
		final DynamicConfig convertedConfig = convertedConfigs.get(smallName);
		if (convertedConfig != null)
		{
			final DynamicConfig dynamicConfig = convertedConfig;
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getOrLoadMap"));
			return dynamicConfig;
		}
		else
		{
	...
	private DynamicConfig getOrLoadMapEntry(String name, Class<?> firstType, Class<?> secondType)
	{
		...
		if (convertedConfig != null)
		{
			final DynamicConfig dynamicConfig = convertedConfig;
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getOrLoadMapEntry"));
			return dynamicConfig;
		}
		else
		{
	...
	private DynamicConfig getOrLoadStatsSet(String name, Object... keysAndClasses)
	{
		...
		if (convertedConfig != null)
		{
			final DynamicConfig dynamicConfig = convertedConfig;
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "getOrLoadStatsSet"));
			return dynamicConfig;
		}
		else
		{
	...
	private DynamicConfig loadObject(String name, Class<?> type, boolean logError)
	{
		...
		try
		{
			...
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "loadObject"));
			return dynamicConfig;
		}
	...
	private DynamicConfig loadMap(String name, Class<?> firstType, Class<?> secondType, boolean logError)
	{
		...
		try
		{
			...
			final DynamicConfig dynamicConfig = new DynamicConfig(object, name);
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "loadMap"));
			return dynamicConfig;
		}
		catch (NumberFormatException e)
		{
	...
	private DynamicConfig loadMapEntry(String name, Class<?> firstType, Class<?> secondType, boolean logError)
	{
		...
		try
		{
			...
			final DynamicConfig dynamicConfig = new DynamicConfig(object, name);
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "loadMapEntry"));
			return dynamicConfig;
		}
		catch (NumberFormatException e)
		{
	...
	private DynamicConfig loadStatsSet(String name, boolean logError, Object... keysAndClasses)
	{
		...
		try
		{
			...
			final DynamicConfig dynamicConfig = new DynamicConfig(object, name);
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "loadStatsSet"));
			return dynamicConfig;
		}
		catch (NumberFormatException e)
		{
	...
	private DynamicConfig loadStatsSetList(String name, boolean logError, Object... keysAndClasses)
	{
		...
		try
		{
			...
			final DynamicConfig dynamicConfig = new DynamicConfig(object, name);
			if (dynamicConfig == null)
				throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "l2r/gameserver/ConfigHolder", "loadStatsSetList"));
			return dynamicConfig;
		}
		catch (NumberFormatException e)
		{
