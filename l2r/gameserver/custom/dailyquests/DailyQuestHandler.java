 ...
 */
package l2r.gameserver.custom.dailyquests;
...
import l2r.gameserver.custom.dailyquests.quests.ClassSpecificPvPDailyQuest;
import l2r.gameserver.custom.dailyquests.quests.EnchantingDailyQuest;
import l2r.gameserver.custom.dailyquests.quests.FishingDailyQuest;
import l2r.gameserver.custom.dailyquests.quests.GeneralPvPDailyQuest;
import l2r.gameserver.custom.dailyquests.quests.PKHunterDailyQuest;
...
import l2r.gameserver.model.items.ItemHold;
...
import l2r.gameserver.skills.SkillHold;
...
public class DailyQuestHandler extends AbstractDPScript implements ICommunityBoardHandler, OnPlayerEnterListener
{
	...
	public void onPlayerEnter(Player player)
	{
		...
		if (!hasQuestTaken)
		{
			player.sendPacket(new Say2(0, ChatType.BATTLEFIELD, "Daily Quest Engine", "There are daily quests available for you.\nTry them from ALt + B -> Daily Quests"));
		}
	}
