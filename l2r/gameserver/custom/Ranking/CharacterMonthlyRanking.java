...
//import  l2r.gameserver.custom.Ranking.ServerRanking.RankingTopMember;
//
//
///**
...
//		{
//			final List<RankingTopMember> sortedTop = new ArrayList<>(rank.getPlayers());
//			sortedTop.sort(RANKING_POINTS_COMPARATOR);
//
