...
public class SkillsEngine
{
	...
	public Map<Integer, Skill> loadAllSkills()
	{
		...
		final Map<Integer, Skill> result = new HashMap<>(66100);
		int maxId = 0, maxLvl = 0;
		
		if (Config.CUSTOM_SKILLS_LOAD)
		{
			files.addAll(FileUtils.listFiles(new File(dir + "/custom"), FileFilterUtils.suffixFileFilter(".xml"), FileFilterUtils.directoryFileFilter()));
		}
