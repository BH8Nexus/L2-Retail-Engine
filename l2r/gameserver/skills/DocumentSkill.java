...
public final class DocumentSkill extends DocumentBase
{
	...
	public class SkillTemplate
	{
		...
		public List<Skill> skills = new ArrayList<>(100);
		public List<Skill> currentSkills = new ArrayList<>(100);
	}
	...
	private void setCurrentSkill(SkillTemplate skill)
	{
		currentSkill = skill;
	}
		...
		for (Node n = doc.getFirstChild(); n != null; n = n.getNextSibling())
		{
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					...
					{
						setCurrentSkill(new SkillTemplate());
						parseSkill(d);
	...
	protected void parseSkill(Node n)
	{
		...
		try
		{
			Map<Integer, Integer> displayLevels = new HashMap<>(100);
