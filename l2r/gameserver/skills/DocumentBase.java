...
import l2r.gameserver.stats.conditions.ConditionFirstEffectSuccess;
import l2r.gameserver.stats.conditions.ConditionGameTime;
import l2r.gameserver.stats.conditions.ConditionGameTime.CheckGameTime;
import l2r.gameserver.stats.conditions.ConditionHasSkill;
import l2r.gameserver.stats.conditions.ConditionLogicAnd;
import l2r.gameserver.stats.conditions.ConditionLogicNot;
import l2r.gameserver.stats.conditions.ConditionLogicOr;
import l2r.gameserver.stats.conditions.ConditionPlayerAgathion;
import l2r.gameserver.stats.conditions.ConditionPlayerClassId;
import l2r.gameserver.stats.conditions.ConditionPlayerCubic;
import l2r.gameserver.stats.conditions.ConditionPlayerDivision;
import l2r.gameserver.stats.conditions.ConditionPlayerFightClub;
import l2r.gameserver.stats.conditions.ConditionPlayerHasBuff;
import l2r.gameserver.stats.conditions.ConditionPlayerHasBuffId;
import l2r.gameserver.stats.conditions.ConditionPlayerInstanceZone;
import l2r.gameserver.stats.conditions.ConditionPlayerMaxLevel;
import l2r.gameserver.stats.conditions.ConditionPlayerMaxPK;
import l2r.gameserver.stats.conditions.ConditionPlayerMinLevel;
import l2r.gameserver.stats.conditions.ConditionPlayerMinMaxDamage;
import l2r.gameserver.stats.conditions.ConditionPlayerOlympiad;
import l2r.gameserver.stats.conditions.ConditionPlayerPercentCp;
import l2r.gameserver.stats.conditions.ConditionPlayerPercentHp;
import l2r.gameserver.stats.conditions.ConditionPlayerPercentMp;
import l2r.gameserver.stats.conditions.ConditionPlayerRace;
import l2r.gameserver.stats.conditions.ConditionPlayerRiding;
import l2r.gameserver.stats.conditions.ConditionPlayerRiding.CheckPlayerRiding;
import l2r.gameserver.stats.conditions.ConditionPlayerState;
import l2r.gameserver.stats.conditions.ConditionPlayerState.CheckPlayerState;
import l2r.gameserver.stats.conditions.ConditionPlayerSummonSiegeGolem;
import l2r.gameserver.stats.conditions.ConditionSlotItemId;
import l2r.gameserver.stats.conditions.ConditionTargetActiveSkillId;
import l2r.gameserver.stats.conditions.ConditionTargetAggro;
import l2r.gameserver.stats.conditions.ConditionTargetCastleDoor;
import l2r.gameserver.stats.conditions.ConditionTargetClan;
import l2r.gameserver.stats.conditions.ConditionTargetClassId;
import l2r.gameserver.stats.conditions.ConditionTargetDirection;
import l2r.gameserver.stats.conditions.ConditionTargetForbiddenClassId;
import l2r.gameserver.stats.conditions.ConditionTargetHasBuff;
import l2r.gameserver.stats.conditions.ConditionTargetHasBuffId;
import l2r.gameserver.stats.conditions.ConditionTargetHasForbiddenSkill;
import l2r.gameserver.stats.conditions.ConditionTargetMob;
import l2r.gameserver.stats.conditions.ConditionTargetMobId;
import l2r.gameserver.stats.conditions.ConditionTargetNpcClass;
import l2r.gameserver.stats.conditions.ConditionTargetPercentCp;
import l2r.gameserver.stats.conditions.ConditionTargetPercentHp;
import l2r.gameserver.stats.conditions.ConditionTargetPercentMp;
import l2r.gameserver.stats.conditions.ConditionTargetPlayable;
import l2r.gameserver.stats.conditions.ConditionTargetPlayer;
import l2r.gameserver.stats.conditions.ConditionTargetPlayerRace;
import l2r.gameserver.stats.conditions.ConditionTargetRace;
import l2r.gameserver.stats.conditions.ConditionTargetSummon;
import l2r.gameserver.stats.conditions.ConditionUsingArmor;
import l2r.gameserver.stats.conditions.ConditionUsingItemType;
import l2r.gameserver.stats.conditions.ConditionUsingSkill;
import l2r.gameserver.stats.conditions.ConditionZoneType;
...
abstract class DocumentBase
{
	...
	Document parse()
	{
		...
		try
		{
			...
			doc = factory.newDocumentBuilder().parse(new FileInputStream(file));
		}
	...
	protected void attachEffect(Node n, Object template)
	{
		...
		if (attrs.getNamedItem("minChance") != null)
		{
			set.set("minChance", parseNumber(attrs.getNamedItem("minChance").getNodeValue()).intValue());
		}
		if (attrs.getNamedItem("maxChance") != null)
		{
			set.set("maxChance", parseNumber(attrs.getNamedItem("maxChance").getNodeValue()).intValue());
		}
	...
	protected Condition parsePlayerCondition(Node n)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			{
				int divisionOrdinal = parseNumber(a.getNodeValue()).intValue();
				cond = joinAnd(cond, new ConditionPlayerDivision(divisionOrdinal));
			}
	...
	protected Condition parseTargetCondition(Node n)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			{
				cond = joinAnd(cond, new ConditionTargetDirection(Location.TargetDirection.valueOf(nodeValue.toUpperCase())));
			}
			else if ("percentHP".equalsIgnoreCase(nodeName))
			{
			...
			{
				cond = joinAnd(cond, new ConditionTargetClassId(a.getNodeValue().split(",")));
			}
		}
		if (cond == null)
		{
