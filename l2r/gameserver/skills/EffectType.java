...
import l2r.gameserver.skills.effects.EffectAddSkills;
import l2r.gameserver.skills.effects.EffectAgathionRes;
import l2r.gameserver.skills.effects.EffectAggression;
import l2r.gameserver.skills.effects.EffectBetray;
import l2r.gameserver.skills.effects.EffectBlessNoblesse;
import l2r.gameserver.skills.effects.EffectBlockStat;
import l2r.gameserver.skills.effects.EffectBluff;
import l2r.gameserver.skills.effects.EffectBuff;
import l2r.gameserver.skills.effects.EffectCPDamPercent;
import l2r.gameserver.skills.effects.EffectCallSkills;
import l2r.gameserver.skills.effects.EffectCharge;
import l2r.gameserver.skills.effects.EffectCharmOfCourage;
import l2r.gameserver.skills.effects.EffectCombatPointHealOverTime;
import l2r.gameserver.skills.effects.EffectConsumeSoulsOverTime;
import l2r.gameserver.skills.effects.EffectCubic;
import l2r.gameserver.skills.effects.EffectCurseOfLifeFlow;
import l2r.gameserver.skills.effects.EffectDamOverTime;
import l2r.gameserver.skills.effects.EffectDamOverTimeLethal;
import l2r.gameserver.skills.effects.EffectDebuffImmunity;
import l2r.gameserver.skills.effects.EffectDestroySummon;
import l2r.gameserver.skills.effects.EffectDisarm;
import l2r.gameserver.skills.effects.EffectDiscord;
import l2r.gameserver.skills.effects.EffectDispelEffects;
import l2r.gameserver.skills.effects.EffectEnervation;
import l2r.gameserver.skills.effects.EffectFakeDeath;
import l2r.gameserver.skills.effects.EffectFear;
import l2r.gameserver.skills.effects.EffectGrow;
import l2r.gameserver.skills.effects.EffectHPDamPercent;
import l2r.gameserver.skills.effects.EffectHate;
import l2r.gameserver.skills.effects.EffectHeal;
import l2r.gameserver.skills.effects.EffectHealBlock;
import l2r.gameserver.skills.effects.EffectHealCPPercent;
import l2r.gameserver.skills.effects.EffectHealOverTime;
import l2r.gameserver.skills.effects.EffectHealPercent;
import l2r.gameserver.skills.effects.EffectHourglass;
import l2r.gameserver.skills.effects.EffectImmobilize;
import l2r.gameserver.skills.effects.EffectInterrupt;
import l2r.gameserver.skills.effects.EffectInvisible;
import l2r.gameserver.skills.effects.EffectInvulnerable;
import l2r.gameserver.skills.effects.EffectLDManaDamOverTime;
import l2r.gameserver.skills.effects.EffectLockInventory;
import l2r.gameserver.skills.effects.EffectMPDamPercent;
import l2r.gameserver.skills.effects.EffectManaDamOverTime;
import l2r.gameserver.skills.effects.EffectManaHeal;
import l2r.gameserver.skills.effects.EffectManaHealOverTime;
import l2r.gameserver.skills.effects.EffectManaHealPercent;
import l2r.gameserver.skills.effects.EffectMeditation;
import l2r.gameserver.skills.effects.EffectMute;
import l2r.gameserver.skills.effects.EffectMuteAll;
import l2r.gameserver.skills.effects.EffectMuteAttack;
import l2r.gameserver.skills.effects.EffectMutePhisycal;
import l2r.gameserver.skills.effects.EffectNegateEffects;
import l2r.gameserver.skills.effects.EffectNegateMusic;
import l2r.gameserver.skills.effects.EffectParalyze;
import l2r.gameserver.skills.effects.EffectPetrification;
import l2r.gameserver.skills.effects.EffectRandomHate;
import l2r.gameserver.skills.effects.EffectRelax;
import l2r.gameserver.skills.effects.EffectRemoveTarget;
import l2r.gameserver.skills.effects.EffectRestoration;
import l2r.gameserver.skills.effects.EffectRestorationRandom;
import l2r.gameserver.skills.effects.EffectRoot;
import l2r.gameserver.skills.effects.EffectSalvation;
import l2r.gameserver.skills.effects.EffectServitorShare;
import l2r.gameserver.skills.effects.EffectSilentMove;
import l2r.gameserver.skills.effects.EffectSleep;
import l2r.gameserver.skills.effects.EffectStun;
import l2r.gameserver.skills.effects.EffectSummonHealPercent;
import l2r.gameserver.skills.effects.EffectSummonManaHealPercent;
import l2r.gameserver.skills.effects.EffectSymbol;
import l2r.gameserver.skills.effects.EffectTemplate;
import l2r.gameserver.skills.effects.EffectTransformation;
import l2r.gameserver.skills.effects.EffectUnAggro;
import l2r.gameserver.skills.effects.EffectVitalityDamOverTime;
import l2r.gameserver.skills.effects.EffectVitalityStop;
import l2r.gameserver.stats.Env;
import l2r.gameserver.stats.Stats;

public enum EffectType
{
	// ÐžÑ�Ð½Ð¾Ð²Ð½Ñ‹Ðµ Ñ�Ñ„Ñ„ÐµÐºÑ‚Ñ‹
	...
	AbsorbDamageToEffector(EffectBuff.class, null, false), // Ð°Ð±Ñ�Ð¾Ñ€Ð±Ð¸Ñ€ÑƒÐµÑ‚ Ñ‡Ð°Ñ�Ñ‚ÑŒ Ð´Ð°Ð¼Ð°Ð³Ð° Ðº ÐµÑ„Ñ„ÐµÐºÑ‚Ð¾Ñ€Ð° ÐµÑ„Ñ„ÐµÐºÑ‚Ð°
	AbsorbDamageToMp(EffectBuff.class, AbnormalEffect.S_ARCANE_SHIELD, false), // Ð°Ð±Ñ�Ð¾Ñ€Ð±Ð¸Ñ€ÑƒÐµÑ‚ Ñ‡Ð°Ñ�Ñ‚ÑŒ Ð´Ð°Ð¼Ð°Ð³Ð° Ð² Ð¼Ð¿
	AbsorbDamageToSummon(EffectLDManaDamOverTime.class, null, true); // Ð°Ð±Ñ�Ð¾Ñ€Ð±Ð¸Ñ€ÑƒÐµÑ‚ Ñ‡Ð°Ñ�Ñ‚ÑŒ Ð´Ð°Ð¼Ð°Ð³Ð° Ðº Ñ�ÑƒÐ¼Ð¾Ð½Ñƒ
