...
public class EffectDiscord extends Effect
{
	...
	public boolean checkCondition()
	{
		...
		if ((skilldiff > 10) || ((skilldiff > 5) && Rnd.chance(90)) || Rnd.chance(Math.abs(lvldiff) * 2))
		{
			return false;
		}
		...
		if (_effected.isFearImmune() || _effected.isRaid() || _effected.isChampion() || (_effected.getChampionTemplate() != null))
		{
			if (!multitargets)
			{
				getEffector().sendPacket(SystemMsg.THAT_IS_AN_INCORRECT_TARGET);
