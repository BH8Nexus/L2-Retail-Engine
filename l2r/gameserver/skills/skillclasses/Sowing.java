	...
	public void useSkill(Creature activeChar, List<Creature> targets)
	{
		...
		for (Creature target : targets)
		{
			if (target != null)
			{
				...
				// Ð¨Ñ‚Ñ€Ð°Ñ„, Ð½Ð° Ñ€Ð°Ð·Ð½Ð¸Ñ†Ñƒ ÑƒÑ€Ð¾Ð²Ð½ÐµÐ¹ Ð¼ÐµÐ¶Ð´Ñƒ Ð¼Ð¾Ð±Ð¾Ð¼ Ð¸ Ð¸Ð³Ñ€Ð¾ÐºÐ¾Ð¼
				// 5% Ð½Ð° ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ Ð¿Ñ€Ð¸ Ñ€Ð°Ð·Ð½Ð¸Ñ†Ðµ >5 - Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ
				...
				// Ð¨Ñ‚Ñ€Ð°Ñ„, Ð½Ð° Ñ€Ð°Ð·Ð½Ð¸Ñ†Ñƒ ÑƒÑ€Ð¾Ð²Ð½ÐµÐ¹ Ð¼ÐµÐ¶Ð´Ñƒ Ñ�ÐµÐ¼ÐµÑ‡ÐºÐ¾Ð¹ Ð¸ Ð¼Ð¾Ð±Ð¾Ð¼
				// 5% Ð½Ð° ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ Ð¿Ñ€Ð¸ Ñ€Ð°Ð·Ð½Ð¸Ñ†Ðµ >5 - Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ
				...
				// ÐœÐ¸Ð½Ð¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑˆÐ°Ð½Ñ� ÑƒÑ�Ð¿ÐµÑ…Ð° Ð²Ñ�ÐµÐ³Ð´Ð° 1%
				if (SuccessRate < 1)
				{
					SuccessRate = 1;
				}
				...
				if (player.isGM())
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.skills.skillclasses.Sowing.Chance", player).addNumber((long) SuccessRate));
				}
