	...
	public void useSkill(Creature activeChar, List<Creature> targets)
	{
		for (Creature target : targets)
		{
			if (target != null)
			{
				...
				player.sendPacket(new Say2(0, ChatType.TELL, "♦", "Player " + activeChar.getName() + " affected you with curse Imprison. You will be imprisoned for " + TimeUtils.minutesToFullString((int) getPower() / 60)));
			}
		}
	}
}