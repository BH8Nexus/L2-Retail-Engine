...
public class FishingSkill extends Skill
{
	...
	public void useSkill(Creature caster, List<Creature> targets)
	{
		...
		int group = l2r.gameserver.model.Fishing.getFishGroup(lure.getItemId());
		int type = l2r.gameserver.model.Fishing.getRandomFishType(lureId);
		int lvl = l2r.gameserver.model.Fishing.getRandomFishLvl(player);
