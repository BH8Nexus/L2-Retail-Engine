...
public class AdminTable
{
	...
	public void load()
	{
		...
		try
		{
			...
			File file = Config.findNonCustomResource("config/accessLevels.xml");
	...
	/**
	 * Returns all access levels in the server
	 * @return the access level instance by char access level
	 */
	...
	{
		if (isGmOnline(player.isGM())) // || !Config.GMLIST_CONTACT_INFORMATION.isEmpty())
		{
			...
			/*
			 * if (!Config.GMLIST_CONTACT_INFORMATION.isEmpty()) { player.sendMessage(",...................................................,"); player.sendMessage("[    Contact Information:    ]"); player.sendMessage("V''''''''''''''''''''''''''''''''''''''''''''''''V");
			 * player.sendMessage(Config.GMLIST_CONTACT_INFORMATION); } }
			 */
		}
		else
		{
