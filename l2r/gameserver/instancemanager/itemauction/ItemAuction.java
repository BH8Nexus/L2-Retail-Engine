...
public class ItemAuction
{
	...
	public void registerBid(Player player, long newBid)
	{
		...
		if (newBid > Config.ALT_ITEM_AUCTION_MAX_BID)
		{
			...
			{
				player.sendMessage(new CustomMessage("l2r.gameserver.instancemanager.itemauction.itemauction.message1", player).addNumber(Config.ALT_ITEM_AUCTION_MAX_BID));
			}
			return;
		}
