...
public class DonationBonusDay
{
	...
	{
		_taskannounce = ThreadPoolManager.getInstance().scheduleAtFixedRate(() -> Announcements.getInstance().announceToAll("Bonus Day: All donations made next " + getTimeLeft() + " will recive " + ServerVariables.getInt("DonationBonusPercent") + "% extra coins bonus!"), delayedAnnounceSeconds * 1000, 60 * 60000); // spam
																																																																															// every
																																																																															// 1
																																																																															// hour.
		
		_taskstoppromotion = ThreadPoolManager.getInstance().scheduleAtFixedRate(() ->
		{
