...
{
	private static final Logger LOG = LoggerFactory.getLogger(WebForum.class);
	...
	private static String CHANGELOG_URL = "/5-changelog/";
	private static String ANNOUNCEMENT_URL = "/4-news/";
	...
	private static ArrayList<ForumTopic> getTopics(String url)
	{
		...
		{
			LOG.warn("Error while reading webpage: ", e);
		}
