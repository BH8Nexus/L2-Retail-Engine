...
public class EmotionsTable
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(EmotionsTable.class);
	...
	public static void init()
	{
		try
		{
			...
			File file = new File(Config.DATAPACK_ROOT + "/data/xml/emotions.xml");
		...
		{
			LOG.warn("Emoticons: Could not pharse the xml...");
			e.printStackTrace();
		}
	}
