...
public class IAchievementCategory
{
	...
	private final List<iAchievement> _achievements = new LinkedList<>();
	...
	public IAchievementCategory(int categoryId, String categoryName, String categoryIcon, String categoryDesc)
	{
