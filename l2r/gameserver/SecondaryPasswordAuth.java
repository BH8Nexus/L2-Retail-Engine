...
public class SecondaryPasswordAuth
{
	...
	private void loadPassword()
	{
		...
		{
			LOG.warn("Error while reading password!", e);
		}
		finally
		{
	...
	public boolean savePassword(String password)
	{
		...
		{
			LOG.warn("Error while writing password.", e);
			return false;
		}
		finally
		{
	...
	public boolean insertWrongAttempt(int attempts)
	{
		...
		{
			LOG.warn("Error while writing wrong attempts.", e);
			return false;
		}
		finally
		{
	...
	private void banAccount(Player plyr)
	{
		...
		{
			LOG.warn("Error while banning account.", e);
		}
	}
	...
	private void ban(Player actor, long time)
	{
		...
		{
			LOG.warn("could not store bans data:" + e);
		}
		finally
		{
	...
	private String cryptPassword(String password)
	{
		...
		{
			LOG.warn("[SecondaryPasswordAuth]Unsupported Algorythm");
		}
		catch (UnsupportedEncodingException e)
		{
			LOG.warn("[SecondaryPasswordAuth]Unsupported Encoding");
		}
		return null;
	}
