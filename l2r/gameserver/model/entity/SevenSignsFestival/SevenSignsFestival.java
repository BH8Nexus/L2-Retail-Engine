...
public class SevenSignsFestival
{
	...
	public void resetFestivalData(boolean updateSettings)
	{
		...
		{
			Functions.removeItem(onlinePlayer, FESTIVAL_BLOOD_OFFERING, Functions.getItemCount(onlinePlayer, FESTIVAL_BLOOD_OFFERING), "");
		}
	 ...
	 */
	public boolean setFinalScore(PlayerGroup party, int oracle, int festivalId, long offeringScore)
	{
