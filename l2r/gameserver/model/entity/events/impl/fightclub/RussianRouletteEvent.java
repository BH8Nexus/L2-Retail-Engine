package l2r.gameserver.model.entity.events.impl.fightclub;
...
/**
 * Russian Roulette event Each turn the players will choose between some russian npcs, and one of those will be the bad russian Those that choose the bad russian will lose the round The last survivor wins
 * @author Synerge
 */
public class RussianRouletteEvent extends AbstractFightClub
{
	...
	public synchronized boolean onTalkNpc(Player player, NpcInstance npc)
	{
		...
		// No esta compitiendo
		if (!_participatingPlayers.containsKey(player.getObjectId()))
		{
			return true;
		}
