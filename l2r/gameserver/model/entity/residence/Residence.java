...
public abstract class Residence implements JdbcEntity
{
	...
	private final List<Integer> _artefacts = new ArrayList<>(1);
...
//	public boolean updateFunctions(Clan clan, int type, int level)
//	{
...
//	}
	...
	public long getPrisonReuseTime() {
		    return this._prisonReuseTime;
	}
		  
	public void setPrisonReuseTime(long time) {
		    this._prisonReuseTime = time;
	}
