...
import l2r.gameserver.dao.FortressDAO;
...
public class Fortress extends Residence
{
	...
	public void changeOwner(Clan clan)
	{
		...
		// if (Config.ENABLE_PLAYER_COUNTERS && (clan != null))
		// {
		// for (UnitMember clanmembers : clan.getAllMembers())
		// {
		// if (clanmembers.isOnline())
		// {
		// clanmembers.getPlayer().getCounters().FortSiegesWon++;
		// }
		// }
		// }
	}
