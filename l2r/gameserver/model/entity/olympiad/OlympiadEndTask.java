...
public class OlympiadEndTask extends RunnableImpl
{
	...
	public void runImpl()
	{
		if (Olympiad._inCompPeriod) // Ð•Ñ�Ð»Ð¸ Ð±Ð¾Ð¸ ÐµÑ‰Ðµ Ð½Ðµ Ð·Ð°ÐºÐ¾Ð½Ñ‡Ð¸Ð»Ð¸Ñ�ÑŒ, Ð¾Ñ‚ÐºÐ»Ð°Ð´Ñ‹Ð²Ð°ÐµÐ¼ Ð¾ÐºÐ¾Ð½Ñ‡Ð°Ð½Ð¸Ðµ Ð¾Ð»Ð¸Ð¼Ð¿Ð¸Ð°Ð´Ñ‹ Ð½Ð° Ð¼Ð¸Ð½ÑƒÑ‚Ñƒ
		{
