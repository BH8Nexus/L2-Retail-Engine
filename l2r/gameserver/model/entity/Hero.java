...
public class Hero
{
	...
	private static Map<Integer, String> _heroMessage; // TODO [VISTALL] унести в StatsSet с каждого героя
	...
	public static void deleteHero(int objectId)
	{
		Connection con = null;
		PreparedStatement statement = null;
		try
	...
	public void activateHero(Player player)
	{
		...
		// Achievement system set hero point and reload data.
