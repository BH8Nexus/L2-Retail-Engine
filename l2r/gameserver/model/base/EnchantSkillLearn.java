...
public final class EnchantSkillLearn
{
	...
	public int[] getCost()
	{
		int[] prices = SkillTable.getInstance().getInfo(_id, 1).isOffensive() ? _priceCombat[_level % 100] : _priceBuff[_level % 100];
		if (Config.RATE_PRICE_ENCHANT_SKILL != 1.0)
		{
			prices[0] *= Config.RATE_PRICE_ENCHANT_SKILL;
			prices[1] *= Config.RATE_PRICE_ENCHANT_SKILL;
		}
	...
	private static final int[][] _chance15 = { {},
		//76  77  78  79  80  81  82  83  84  85
		{ 80, 90, 95, 95, 95, 95, 95, 95, 95, 95 }, // 1
		{ 52, 76, 86, 91, 91, 91, 91, 91, 91, 91 }, // 2
		{ 48, 72, 82, 87, 87, 87, 87, 87, 87, 87 }, // 3
		{ 01, 44, 68, 78, 83, 83, 83, 83, 83, 83 }, // 4
		{ 01, 01, 40, 64, 74, 79, 79, 79, 79, 79 }, // 5
		{ 01, 01, 36, 60, 70, 75, 75, 75, 75, 75 }, // 6
		{ 01, 01, 01, 32, 56, 66, 71, 71, 71, 71 }, // 7
		{ 01, 01, 01, 01, 28, 52, 62, 67, 67, 67 }, // 8
		{ 01, 01, 01, 01, 24, 48, 58, 63, 63, 63 }, // 9
		{ 01, 01, 01, 01, 01, 20, 44, 54, 59, 59 }, // 10
		{ 01, 01, 01, 01, 01, 01, 16, 40, 50, 55 }, // 11
		{ 01, 01, 01, 01, 01, 01, 12, 36, 46, 51 }, // 12
		{ 01, 01, 01, 01, 01, 01, 01, 8, 32, 42  }, // 13
		{ 01, 01, 01, 01, 01, 01, 01, 01, 04, 28 }, // 14
		{ 01, 01, 01, 01, 01, 01, 01, 01, 02, 24 }, // 15
	};
