...
public class AccessLevel
{
	...
	/** Title to set upon access level change */
	private String _title = null;
	/** Titles that players cannot set for themselves and are reserved only for this access level. */
	private String[] _reservedTitles = new String[0];
	/**
	...
	public boolean _useTeleport = true;
	...
	public AccessLevel(StatsSet set)
	{
		...
		_reservedTitles = set.getString("reservedTitles", "").split(";");
		...
		_useTeleport = set.getBool("userteleport", true);
	}
	...
	public String[] getReservedTitles()
	{
		return _reservedTitles;
	}
