...
public class CharSelectInfoPackage
{
	...
	/*
	 * public int getPaperdollItemDisplayId(int slot) { ItemInstance item = _paperdoll[slot]; if(item != null) { if (item.getVisualItemId() > 0) return item.getVisualItemId(); if (item.getdisplayId() > 0) return item.getdisplayId(); return item.getItemId(); } return 0; }
	 */
