...
public class SymbolInstance extends NpcInstance
{
	...
	protected void onSpawn()
	{
		...
		_destroyTask = ThreadPoolManager.getInstance().schedule(new DeleteTask(this), _durationInMilis);
			...
			public void runImpl()
			{
				for (Creature target : getAroundCharacters(200, 200))
				{
					if (_skill.checkTarget(_owner, target, null, false, false) == null)
					{
						...
						// _skill.useSkill(new Env(SymbolInstance.this, null, _skill), targets);
