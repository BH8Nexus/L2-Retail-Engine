...
public final class FestivalGuideInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			player.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2FestivalGuideInstance.cabal", player));
			return;
		}
		...
		else if (command.startsWith("Festival"))
		{
			...
			switch (val)
			{
				...
				case 2: // Festival 2 xxxx
					...
					{
						player.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2FestivalGuideInstance.InProgress", player));
						return;
					}
					...
					{
						player.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2FestivalGuideInstance.NotEnoughSSType", player));
						return;
					}
				...
				case 9: // Leave the Festival
					...
					{
						player.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2FestivalGuideInstance.leaderonly", player));
					}
					break;
				default:
