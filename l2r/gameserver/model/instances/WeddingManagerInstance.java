...
public class WeddingManagerInstance extends NpcInstance
{
	...
	/*
	 * TODO Test System to Test
	 */
	private final int WEDDING_RING_MALE = 21159;
	private final int WEDDING_RING_FEMALE = 21160;
	private final int SALVATION_BOW = 9140;
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("AcceptWedding"))
		{
			...
			Announcements.getInstance().announceByCustomMessage("l2r.gameserver.model.instances.L2WeddingManagerMessage.announce", new String[]
			{
				player.getName(),
				ptarget.getName()
			});
			...
			// {
			// player.getCounters().GetMarried++;
			// ptarget.getCounters().GetMarried++;
			// }
