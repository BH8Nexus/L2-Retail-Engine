		...
		if(params[0].equals("auction"))
		{
			...
			else if(params[1].equals("show"))
			{
				...
				if(currentAuction == null)
				{
					...
					if(nextAuction != null)
						player.sendMessage(new CustomMessage("l2r.gameserver.model.instances.L2ItemAuctionBrokerInstance.message1", player, fmt.format(new Date(nextAuction.getStartingTime()))));
					return;
				}
