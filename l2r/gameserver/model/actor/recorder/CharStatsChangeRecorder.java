...
public class CharStatsChangeRecorder<T extends Creature>
{
	...
	protected void refreshStats()
	{
		...
		_runSpeed = set(BROADCAST_CHAR_INFO, _runSpeed, (int) _activeChar.getRunSpeed());// TODO: Check the cast int if is problem //_runSpeed = set(BROADCAST_CHAR_INFO, _runSpeed, _activeChar.getRunSpeed());
