...
public final class PlayerStatsChangeRecorder extends CharStatsChangeRecorder<Player>
{
	...
	private final FastMap<String, Integer> _stats;
	...
	protected void refreshStats()
	{
		...
		_title = set(BROADCAST_CHAR_INFO, _title, _activeChar.getVisibleTitle(_activeChar));
	...
	private void update()
	{
		_stats.put("patak", calculteBar(_physicAttack, Config.LIMIT_PATK));
		_stats.put("matak", calculteBar(_magicAttack, Config.LIMIT_MATK));
		_stats.put("pdef", calculteBar(_physicDefence, Config.LIMIT_PDEF));
		_stats.put("mdef", calculteBar(_magicDefence, Config.LIMIT_MDEF));
		_stats.put("accuracy", calculteBar(_accuracy, Config.LIMIT_ACCURACY));
		_stats.put("evasion", calculteBar(_evasion, Config.LIMIT_EVASION));
		_stats.put("criticalHit", calculteBar(_criticalHit, Config.LIMIT_CRIT));
		_stats.put("runSpeed", calculteBar(_runSpeed, Config.LIMIT_MOVE));
		_stats.put("attackSpeed", calculteBar(_attackSpeed, Config.LIMIT_PATK_SPD));
		_stats.put("castSpeed", calculteBar(_castSpeed, Config.LIMIT_MATK_SPD));
