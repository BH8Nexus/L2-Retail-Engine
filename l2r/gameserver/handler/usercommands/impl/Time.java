...
public class Time implements IUserCommandHandler
{
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.usercommands.impl.Time.ServerTime", activeChar).addString(sf.format(new Date(System.currentTimeMillis()))));
