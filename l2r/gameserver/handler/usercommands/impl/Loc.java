...
public class Loc implements IUserCommandHandler
{
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		if(msgId > 0)
		{
			...
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.usercommands.impl.loc.message1", activeChar).addNumber(activeChar.getX()).addNumber(activeChar.getY()).addNumber(activeChar.getZ()));
