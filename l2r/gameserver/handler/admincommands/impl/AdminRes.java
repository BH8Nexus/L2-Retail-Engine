		...
		if(player != null)
		{
				...
				try
			{
					...
					for(Creature character : activeChar.getAroundCharacters(radius, radius))
						handleRes(character);
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminres.message1", activeChar).addNumber(radius));
					return;
			}
			catch(NumberFormatException e)
			{
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminres.message2", activeChar));
				return;
			}
		}
