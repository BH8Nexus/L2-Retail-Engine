	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch (command)
		{
			...
			case admin_phantoms_enable:
				...
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message1", activeChar));
			...
			case admin_phantoms_disable:
				...
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message2", activeChar));
				activeChar.sendPacket(new NpcHtmlMessage(5).setFile("admin/phantoms.htm").replace("%phantomcount%", "" + PhantomPlayers.getSpawnedPhantomsCount()));
				break;
				...
				if (wordList.length > 1)
				{
					...
					else
					{
						...
						if (phantom == null)
						{
							...
							activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message3", activeChar).addString(wordList[1]));
						}
						else
						{
							if ((wordList.length > 2) && (wordList[2].equalsIgnoreCase("true") || wordList[2].equalsIgnoreCase("force") || wordList[2].equalsIgnoreCase("perma")))
							{
			...
			case admin_phantoms_spawner:
				try
				{
					...
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message4", activeChar));
					
				}
				catch (Exception e)
				{
					// Original Message: Usage: //phantoms_spawner numSpawns [delayInMilis] [true for generateNew]
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message5", activeChar));
				}
				break;
			...
			case admin_phantoms_stop_spawning:
				...
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message6", activeChar));
				break;
			case admin_phantoms_spawn:
				try
				{
					...
					{
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message10", activeChar));
						return false;
					}
					...
					if (hasClan != "")
					{
						...
						if (rndbotwithclan == -1)
						{
							...
							if (clanPhantom == null)
							{
								activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message8", activeChar));
								return false;
							}
						...
						String name = CharacterDAO.getInstance().getNameByObjectId(rndbotwithclan);
						...
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message9", activeChar).addString(name));
					...
					if (phantom != null)
					{
						...
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message9", activeChar).addString(phantom.getName()));
				...
				{
					// Original Message: Usage: //phantoms_spawn_new [name] [name (human|elf|darkelf|orc|dwarf|kamael) (true for mage)] [name classId (true for female) hairStyle hairColor face]
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message10", activeChar));
				}
				break;
			...
			case admin_phantoms_ai:
				if ((activeChar.getTarget() == null) || !activeChar.getTarget().isPlayer())
				{
					...
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message11", activeChar));
				}
				else if (!activeChar.getTarget().getPlayer().getAI().isPhantomPlayerAI())
				{
					// Original Message: Target is not phantom.
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message12", activeChar));
				}
				else
				{
					...
					if (wordList.length == 1)
					{
						...
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message13", activeChar).addString(ai.getIntention().toString()));
						// Original Message: Mood: " + ai.getMood()
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message14", activeChar).addString(ai.getMood()));
						// Original Message: AttackTarget: " + ai.getAttackTarget()
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.AdminPhantoms.message15", activeChar).addString(ai.getAttackTarget().toString()));
					}
