			...
			case admin_addpoints:
				try
				{
					...
					if(obj != null && obj.isPlayer())
					{
						...
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpspoints.message1", activeChar).addNumber(add));
					}
					else
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpspoints.message2", activeChar).addString(targetName));
				}
			...
			case admin_delpoints:
				try
				{
					...
					if(obj != null && obj.isPlayer())
					{
						...
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpspoints.message4", activeChar).addNumber(reduce));
					}
					else
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpspoints.message5", activeChar).addString(targetName));
				}
				catch(IndexOutOfBoundsException e)
				{
