			...
			switch (command)
			{
				...
				case admin_unban:
				{
					...
					if (charName != null)
					{
						...
						{
							// Original Message: Character " + charName + " has been unbanned.
							activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminban.unbanned", activeChar).addString(charName));
						}
						else
						{
							// Original Message: No such character!
							activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminban.nosuch", activeChar));
						}
					}
					else
					{
						// Original Message: Specify character name.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminban.needinput", activeChar));
					}
					break;
				}
				case admin_accban:
				...
				case admin_accunban:
				{
					...
					{
						// Original Message: Specify account name.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminban.specifyaccount", activeChar));
					}
					break;
				}
