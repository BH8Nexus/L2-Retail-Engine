...
import l2r.gameserver.dao.DatabaseBackupManager;
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch (command)
		{
			...
			case admin_shutdown:
			{
				...
				html.replace("%shutdownMode%", Shutdown.getInstance().toString());
				...
				html.replace("%tradersCount%", GameObjectsStorage.getAllPlayersCount());
			...
			{
				if (Shutdown.getInstance().getMode() == Shutdown.NONE)
				{
					return true;
				}
