...
public class AdminEnchant implements IAdminCommandHandler
{
	...
	private void setEnchant(Player activeChar, int ench, int armorType)
	{
		...
		if(itemInstance != null)
		{
			...
			// informations
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminenchant.message5", activeChar).addString(player.getName()).addString(itemInstance.getName()).addNumber(curEnchant).addNumber(ench));
			player.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminenchant.message6", player).addString(itemInstance.getName()).addNumber(curEnchant).addNumber(ench));
		}
	}
