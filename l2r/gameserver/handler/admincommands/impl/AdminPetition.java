	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_accept_petition:
				if(petitionId < 0)
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpetition.message1", activeChar));
					return false;
				}
			...
			case admin_reject_petition:
				if(petitionId < 0)
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpetition.message2", activeChar));
					return false;
				}
			...
			case admin_force_peti:
				...
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpetition.message3", activeChar));
					return false;
				}
				try
				{
				...
				{
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.adminpetition.message4", activeChar));
					return false;
				}
				break;
		}
