...
public class AdminEventMatch implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		try
		{
			...
			switch (wordList[1])
			{
				...
				case "info":
					...
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.admineventmatch.message4", activeChar).addNumber(raceId));
					...
					break;
				default:
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.admineventmatch.message12", activeChar).addString(fullString));
			}
		...
		{
			e.printStackTrace();
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.admincommands.impl.admineventmatch.message13", activeChar).addString(fullString));
		}
		return true;
	}
}
