...
public class Hellbound extends Functions implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player activeChar, String target)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.voicecommands.impl.hellbound.message1", activeChar).addNumber(HellboundManager.getHellboundLevel()));
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.handler.voicecommands.impl.hellbound.message2", activeChar).addNumber(HellboundManager.getConfidence()));
		}
		return false;
	}
}
