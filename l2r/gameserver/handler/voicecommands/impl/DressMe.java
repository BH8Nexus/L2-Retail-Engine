...
import l2r.gameserver.data.xml.holder.DressArmorHolder;
import l2r.gameserver.data.xml.holder.DressCloakHolder;
import l2r.gameserver.data.xml.holder.DressShieldHolder;
import l2r.gameserver.data.xml.holder.DressWeaponHolder;
...
import l2r.gameserver.network.clientpackets.RequestPreviewItem.RemoveWearItemsTask;
...
public class DressMe implements IVoicedCommandHandler
{
	...
	private static Map<Integer, DressWeaponData> SWORD = new HashMap<>();
	private static Map<Integer, DressWeaponData> BLUNT = new HashMap<>();
	private static Map<Integer, DressWeaponData> DAGGER = new HashMap<>();
	private static Map<Integer, DressWeaponData> BOW = new HashMap<>();
	private static Map<Integer, DressWeaponData> POLE = new HashMap<>();
	private static Map<Integer, DressWeaponData> FIST = new HashMap<>();
	private static Map<Integer, DressWeaponData> DUAL = new HashMap<>();
	private static Map<Integer, DressWeaponData> DUALFIST = new HashMap<>();
	private static Map<Integer, DressWeaponData> BIGSWORD = new HashMap<>();
	private static Map<Integer, DressWeaponData> ROD = new HashMap<>();
	private static Map<Integer, DressWeaponData> BIGBLUNT = new HashMap<>();
	private static Map<Integer, DressWeaponData> CROSSBOW = new HashMap<>();
	private static Map<Integer, DressWeaponData> RAPIER = new HashMap<>();
	private static Map<Integer, DressWeaponData> ANCIENTSWORD = new HashMap<>();
	private static Map<Integer, DressWeaponData> DUALDAGGER = new HashMap<>();
	...
	public boolean useVoicedCommand(String command, Player player, String args)
	{
		...
		else if (command.equals("dress-armor"))
		{
			...
			/*
			 * ItemTemplate visual = ItemHolder.getInstance().getTemplate(dress.getChest()); if (chest.getTemplate().getBodyPart() != visual.getBodyPart()) { player.sendMessage("Error: You can't change visual chest to full body and on the contrary!"); useVoicedCommand("dress-armorpage", player,
			 * args); return false; }
			 */
