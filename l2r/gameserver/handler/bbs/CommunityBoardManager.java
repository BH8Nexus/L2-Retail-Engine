...
import l2r.gameserver.custom.dailyquests.DailyQuestHandler;
...
public class CommunityBoardManager
{
	...
	private CommunityBoardManager()
	{
		...
		registerHandler(ForumBBSManager.getInstance());
	}
	 ...
	 * @param player
	 * @param bypass
	 * @return true if handler is found, false if handler is not found.
	 */
	public boolean executeBypass(Player player, String bypass)
	{
