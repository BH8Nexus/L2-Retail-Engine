...
{
	protected TIntSet _blockedTimers = new TIntHashSet();
	...
	@Override
	protected void onEvtFinishCasting(Skill skills, Creature target)
	{
	...
	{
		final List<NpcInstance> npcs = World.getAroundNpc(getActor(), radius, radius);
