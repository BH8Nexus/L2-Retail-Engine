...
//				if (args.length > 0)
//				{
//					onEvtFinishCasting((Skill) args[0], (Creature) args[1]);
//				}
//				else
//				{
//					onEvtFinishCasting();
//				}
	...
	/**
	 * Π�Ρ�Ρ‚Π°Π½Π°Π²Π»ΠΈΠ²Π°ΠµΡ‚ Π΄Π²ΠΈΠ¶ΠµΠ½ΠΈΠµ
	 * @param validate - Ρ€Π°Ρ�Ρ�Ρ‹Π»Π°Ρ‚Ρ� Π»ΠΈ ValidateLocation
	 */
	...
	/**
	 * Π�Ρ�Ρ‚Π°Π½Π°Π²Π»ΠΈΠ²Π°ΠµΡ‚ Π΄Π²ΠΈΠ¶ΠµΠ½ΠΈΠµ ΠΈ Ρ€Π°Ρ�Ρ�Ρ‹Π»Π°ΠµΡ‚ ValidateLocation
	 */
	...
	/** Π�Π·Π½Π°Ρ‡Π°ΠµΡ‚, Ρ‡Ρ‚ΠΎ AI Π²Ρ�ΠµΠ³Π΄Π° Π²ΠΊΠ»Ρ�Ρ‡ΠµΠ½, Π½ΠµΠ·Π°Π²ΠΈΡ�ΠΈΠΌΠΎ ΠΎΡ‚ Ρ�ΠΎΡ�Ρ‚ΠΎΡ�Π½ΠΈΡ� Ρ€ΠµΠ³ΠΈΠΎΠ½Π° */
	...
	protected abstract void onEvtFinishCasting(Skill skill, Creature target);
	...
	protected abstract void onEvtMenuSelected(Player paramPlayer, int paramInt1, int paramInt2);
