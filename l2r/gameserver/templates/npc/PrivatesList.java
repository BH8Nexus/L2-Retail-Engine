...
public class PrivatesList
{
	 ...
	 * @param addMap - true добавить в мап для дальнейшего использования; - false не будет добавлять в мап более гибкая система если вдруг нужно описать миниона;
	 */
	 ...
	 * @param addMap - true добавить в мап для дальнейшего использования - при респавне главари или смерти обязательно зачистить мап; - false не будет добавлять в мап более гибкая система если вдруг нужно описать миниона;
	 */
	...
	/**
	 * Удаляет минионов и чистит список Работает только с createOnePrivateEx
	 */
	...
	/**
	 * @return имеются ли живые минионы Работает только с createOnePrivateEx
	 */
	...
	/**
	 * Возвращает список живых минионов
	 * @return список живых минионов Работает только с createOnePrivateEx
	 */
	...
	/**
	 * Спавнит 1 миниона подобие класса как в птс P.S - еще сыроват развить...
	 * @param minion_id - ид миниона
	 ...
	 * @param i0
	 * @param i1
	 * @param addMap - true добавить в мап для дальнейшего использования - при респавне главаря или смерти обязательно зачистить мап; - false не будет добавлять в мап более гибкая система если вдруг нужно описать миниона в аи;
	 */
