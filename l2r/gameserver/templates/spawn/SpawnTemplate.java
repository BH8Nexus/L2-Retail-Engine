...
public class SpawnTemplate
{
	...
	private final List<Territory> _territoris_name = new CopyOnWriteArrayList<>();
	...
	{
		_territoris_name.add(territory);
	}
	
	public List<Territory> getTerritoris()
	{
		return _territoris_name;
	}
