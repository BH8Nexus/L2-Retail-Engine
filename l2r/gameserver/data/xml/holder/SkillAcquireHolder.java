...
public final class SkillAcquireHolder extends AbstractHolder
{
	...
	private final TIntObjectHashMap<List<SkillLearn>> _normalSkillTree = new TIntObjectHashMap<>(57500);
	private final TIntObjectHashMap<List<SkillLearn>> _transferSkillTree = new TIntObjectHashMap<>(100);
	// расовые зависимости
	private final TIntObjectHashMap<List<SkillLearn>> _fishingSkillTree = new TIntObjectHashMap<>(670);
	private final TIntObjectHashMap<List<SkillLearn>> _transformationSkillTree = new TIntObjectHashMap<>(120);
	// без зависимостей
	private final List<SkillLearn> _certificationSkillTree = new ArrayList<>(72);
	private final List<SkillLearn> _collectionSkillTree = new ArrayList<>();
	private final List<SkillLearn> _pledgeSkillTree = new ArrayList<>(45);
	private final List<SkillLearn> _subUnitSkillTree = new ArrayList<>(20);
