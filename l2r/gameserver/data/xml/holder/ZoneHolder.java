...
public class ZoneHolder extends AbstractHolder
{
	...
	private final Map<String, ZoneTemplate> _zones = new HashMap<>(1200);
	private final Map<Integer, ZoneTemplate> _dynamicZones = new HashMap<>();
	...
	public void addDynamicZoneTemplate(int id, ZoneTemplate zone)
	{
		_dynamicZones.put(id, zone);
	}
	...
	public ZoneTemplate getDynamicZoneTemplate(int id)
	{
		return _dynamicZones.get(id);
	}
