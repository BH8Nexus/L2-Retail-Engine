...
public final class StaticObjectHolder extends AbstractHolder
{
	...
	private final IntObjectMap<StaticObjectTemplate> _templates = new HashIntObjectMap<>(50);
	private final IntObjectMap<StaticObjectInstance> _spawned = new HashIntObjectMap<>(50);
