...
import l2r.commons.data.xml.AbstractDirParser;
...
import l2r.gameserver.model.entity.events.actions.ActiveDeactiveAction;
import l2r.gameserver.model.entity.events.actions.AnnounceAction;
import l2r.gameserver.model.entity.events.actions.GiveItemAction;
import l2r.gameserver.model.entity.events.actions.IfElseAction;
import l2r.gameserver.model.entity.events.actions.InitAction;
import l2r.gameserver.model.entity.events.actions.NpcSayAction;
import l2r.gameserver.model.entity.events.actions.OpenCloseAction;
import l2r.gameserver.model.entity.events.actions.PlaySoundAction;
import l2r.gameserver.model.entity.events.actions.RefreshAction;
import l2r.gameserver.model.entity.events.actions.SayAction;
import l2r.gameserver.model.entity.events.actions.SpawnDespawnAction;
import l2r.gameserver.model.entity.events.actions.StartStopAction;
import l2r.gameserver.model.entity.events.actions.TeleportPlayersAction;
import l2r.gameserver.model.entity.events.objects.BoatPoint;
import l2r.gameserver.model.entity.events.objects.CTBTeamObject;
import l2r.gameserver.model.entity.events.objects.CastleDamageZoneObject;
import l2r.gameserver.model.entity.events.objects.DoorObject;
import l2r.gameserver.model.entity.events.objects.FortressCombatFlagObject;
...
public final class EventParser extends AbstractDirParser<EventHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for (Iterator<Element> iterator = rootElement.elementIterator("event"); iterator.hasNext();)
		{
			...
			try
			{
				eventClass = (Class<GlobalEvent>) Class.forName("l2r.gameserver.model.entity.events.impl." + impl + "Event");
			}
			...
			set.set("id", id);
			set.set("name", name);
			set.set("eventClass", "l2r.gameserver.model.entity.events.impl." + impl + "Event");
