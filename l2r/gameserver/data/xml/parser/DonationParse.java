...
import l2r.gameserver.data.xml.holder.DonationHolder;
import l2r.gameserver.model.donatesystem.Attribution;
import l2r.gameserver.model.donatesystem.DonateItem;
import l2r.gameserver.model.donatesystem.Donation;
import l2r.gameserver.model.donatesystem.Enchant;
import l2r.gameserver.model.donatesystem.FoundList;
import l2r.gameserver.model.donatesystem.SimpleList;
...
public final class DonationParse extends AbstractFileParser<DonationHolder>
{
	...
	{
		return new File(Config.DATAPACK_ROOT, "data/xml/stats/donation/donation.xml");
	}
