...
import l2r.gameserver.data.xml.holder.ExchangeItemHolder;
import l2r.gameserver.model.exchange.Change;
import l2r.gameserver.model.exchange.Variant;
...
public final class ExchangeItemParser extends AbstractFileParser<ExchangeItemHolder>
{
	...
	{
		return new File(Config.DATAPACK_ROOT, "data/xml/stats/Exchange/exchange.xml");
	}
