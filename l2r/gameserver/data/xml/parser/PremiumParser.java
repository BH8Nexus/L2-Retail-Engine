...
import l2r.gameserver.model.premium.PremiumGift;
import l2r.gameserver.model.premium.PremiumKeys;
import l2r.gameserver.model.premium.PremiumRemoveItems;
...
public final class PremiumParser extends AbstractFileParser<PremiumHolder>
{
	...
	{
		return new File(Config.DATAPACK_ROOT, "data/xml/stats/premium/premium.xml");
	}
	...
	protected void readData(Element rootElement) throws Exception
	{
		for (Iterator<org.dom4j.Element> iterator = rootElement.elementIterator("premium"); iterator.hasNext();)
		{
			...
			int price_count = Integer.parseInt(price.attributeValue("count"));
