...
import l2r.gameserver.model.entity.events.objects.UCMemberObject;
import l2r.gameserver.model.entity.events.objects.UCTeamObject;

/**
 * @author VISTALL <packet id="FE;007E" name="ExPVPMatchRecord" extended="true"> <part name="state" type="d" /> <!--0 - start, 1 - update, 2 - finish--> <part name="win-index" type="d" /> <part name="loose-index" type="d" /> <part name="blue_kills" type="d" /> <part name="red_kills" type="d" />
 *         <part name="blue_size" type="d" id="0"/> <for id="0"> <part name="name" type="S" /> <part name="kills" type="d" /> <part name="deaths" type="d" /> </for> <part name="red_size" type="d" id="1"/> <for id="1"> <part name="name" type="S" /> <part name="kills" type="d" />
