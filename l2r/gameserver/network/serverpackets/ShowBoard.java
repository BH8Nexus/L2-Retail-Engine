...
public class ShowBoard extends L2GameServerPacket
{
	...
	public static void separateAndSend(String html, Player player, boolean force)
	{
		...
		if (player.getResurrectionShowBoardBlockTime() > System.currentTimeMillis())
		{
			sendErrorMessageToPlayer(player, "You must wait " + ((player.getResurrectionShowBoardBlockTime() - System.currentTimeMillis()) / 1000) + " second(s).");
			return;
		}
