...
public class GMViewCharacterInfo extends L2GameServerPacket
{
	...
	private final int _runSpd, _walkSpd, _swimSpd, _flyRunSpd, _flyWalkSpd, DwarvenCraftLevel, running, pledge_class;
	...
	public GMViewCharacterInfo(final Player cha)
	{
		...
		karma = cha.getKarma();
		move_speed = cha.isRunning() ? cha.getRunSpeedMultiplier() : cha.getWalkSpeedMultiplier();
		...
		_flyRunSpd = (int) (cha.isFlying() ? cha.getRunSpeed() / move_speed : 0);
		_flyWalkSpd = (int) (cha.isFlying() ? cha.getWalkSpeed() / move_speed : 0);
