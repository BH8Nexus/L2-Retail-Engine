...
public class Say2 extends NpcStringContainer
{
	...
	public Say2(int objectId, ChatType type, String charName, String[] texts)
	{
		this(objectId, type, charName, NpcString.NONE, texts);
	}
	...
	protected final void writeImpl()
	{
		...
		if(player != null)
		{
			...
			if (player.getObjectId() == _objectId && !player.getName().equals(_charName)) // Support for PM commands during supersnoop for GMs
				AdminCommandHandler.getInstance().useAdminCommandHandler(player, _text);
		}
	}
}