...
public class Die extends L2GameServerPacket
{
	...
	public Die(Creature cha)
	{
		...
		else if (cha.isPlayer() && GmEventManager.getInstance().canResurrect(cha.getPlayer()))
		{
			...
			put(RestartType.FIXED, player.getAccessLevel().allowFixedRes() || (((player.getInventory().getCountOf(10649) > 0) || (player.getInventory().getCountOf(13300) > 0)) && !player.isOnSiegeField()));
