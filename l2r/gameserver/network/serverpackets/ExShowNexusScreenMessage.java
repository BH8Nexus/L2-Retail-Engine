 ...
 * @author Kerberos
 */
public class ExShowNexusScreenMessage extends L2GameServerPacket
{
	 ...
	 */
	public ExShowNexusScreenMessage(String text, int time)
	{
		_type = 2;
		_sysMessageId = -1;
		_unk1 = 0;
	 ...
	 */
	public ExShowNexusScreenMessage(NpcString npcString, int position, int time, String... params)
	{
		_type = 2;
		_sysMessageId = -1;
		_unk1 = 0x00;
	 ...
	 * @param params the String parameters
	 */
	public ExShowNexusScreenMessage(int type, int messageId, int position, int unk1, int size, int unk2, int unk3, boolean showEffect, int time, boolean fade, String text, NpcString npcString, String params)
	{
		_type = type;
	...
	public ExShowNexusScreenMessage(int type, int messageId, int position, int unk1, int size, int unk2, int unk3, boolean showEffect, int time, boolean fade, String text)
	{
		_type = type;
		_sysMessageId = messageId;
		_unk1 = unk1;
