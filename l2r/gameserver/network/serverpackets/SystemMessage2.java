...
//	public static SystemMessage2 obtainItems(ItemInstance item)
//	{
//		return obtainItems(item.getdisplayId() > 0 ? item.getdisplayId() : item.getItemId(), item.getCount(), item.isEquipable() ? item.getEnchantLevel() : 0);
//	}
//
//	public static SystemMessage2 obtainItemsBy(int itemId, long count, int enchantLevel, Creature target)
//	{
...
//	public static SystemMessage2 obtainItemsBy(ItemInstance item, Creature target)
//	{
//		return obtainItemsBy(item.getdisplayId() > 0 ? item.getdisplayId() : item.getItemId(), item.getCount(), item.isEquipable() ? item.getEnchantLevel() : 0, target);
//	}
//
//	public static SystemMessage2 removeItems(int itemId, long count)
//	{
...
//	public static SystemMessage2 removeItems(ItemInstance item)
//	{
//		return removeItems(item.getdisplayId() > 0 ? item.getdisplayId() : item.getItemId(), item.getCount());
//	}
//
//	@Override
//	protected void writeImpl()
