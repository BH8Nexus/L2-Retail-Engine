...
public class UserInfo extends L2GameServerPacket
{
	...
	private final int _runSpd, _walkSpd, _swimRunSpd, _swimWalkSpd, _flRunSpd, _flWalkSpd, _flyRunSpd, _flyWalkSpd;
	...
	public UserInfo(Player player)
	{
		...
		move_speed = player.isRunning() ? player.getRunSpeedMultiplier() : player.getWalkSpeedMultiplier();
		...
		_swimRunSpd = (int) (player.getSwimSpeed() / player.getRunSpeedMultiplier());
		_swimWalkSpd = (int) (player.getSwimSpeed() / player.getWalkSpeedMultiplier());
	...
	protected final void writeImpl()
	{
		...
		title = _player.getVisibleTitle(getClient().getActiveChar());
		name_color = _player.getVisibleNameColor(getClient().getActiveChar());
		title_color = _player.getVisibleTitleColor(getClient().getActiveChar());
