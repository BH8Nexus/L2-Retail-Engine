...
public abstract class L2GameServerPacket extends SendablePacket<GameClient> implements IStaticPacket
{
	 ...
	 * @param b
	 */
	public L2GameServerPacket setInvisible(boolean b)
	{
		_invisible = b;
		return this;
	}
	...
	protected void writeItemElements(MultiSellIngredient item)
	{
		...
		if (item.getItemAttributes().getValue() > 0)
		{
			if (i.isWeapon())
			{
				...
				writeH(0); // Π²ΠΎΠ΄Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (fire pdef)
				writeH(0); // ΠΎΠ³Π½ΠµΠ½Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (water pdef)
				writeH(0); // Π·ΠµΠΌΠ»Ρ�Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (wind pdef)
				writeH(0); // Π²ΠΎΠ·Π΄ΡƒΡ�Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (earth pdef)
				writeH(0); // Ρ‚ΠµΠΌΠ½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (holy pdef)
				writeH(0); // Ρ�Π²ΠµΡ‚Π»Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (dark pdef)
			}
			else if (i.isArmor())
			{
	...
	protected void writeItemElements()
	{
		...
		writeH(0x00); // Π²ΠΎΠ΄Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (fire pdef)
		writeH(0x00); // ΠΎΠ³Π½ΠµΠ½Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (water pdef)
		writeH(0x00); // Π·ΠµΠΌΠ»Ρ�Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (wind pdef)
		writeH(0x00); // Π²ΠΎΠ·Π΄ΡƒΡ�Π½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (earth pdef)
		writeH(0x00); // Ρ‚ΠµΠΌΠ½Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (holy pdef)
		writeH(0x00); // Ρ�Π²ΠµΡ‚Π»Π°Ρ� Ρ�Ρ‚ΠΈΡ…ΠΈΡ� (dark pdef)
	}
