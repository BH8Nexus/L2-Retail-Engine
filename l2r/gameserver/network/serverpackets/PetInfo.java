...
{
	private final int _runSpd, _walkSpd, _swimRunSpd, _swimWalkSpd, _flyRunSpd, _flyWalkSpd, MAtkSpd, PAtkSpd, pvp_flag, karma;
	...
	private final double col_redius, col_height, speed_mult;
	...
	public PetInfo(Summon summon)
	{
		...
		_runSpd = (int) (summon.getRunSpeed() / summon.getRunSpeedMultiplier());
		_walkSpd = (int) (summon.getWalkSpeed() / summon.getWalkSpeedMultiplier());
		_flyRunSpd = (int) (summon.isFlying() ? (summon.getRunSpeed() / summon.getRunSpeedMultiplier()) : 0);
		_flyWalkSpd = (int) (summon.isFlying() ? (summon.getWalkSpeed() / summon.getWalkSpeedMultiplier()) : 0);
		_swimRunSpd = (int) (summon.getSwimSpeed() / summon.getRunSpeedMultiplier());
		_swimWalkSpd = (int) (summon.getSwimSpeed() / summon.getWalkSpeedMultiplier());
		speed_mult = summon.getMovementSpeedMultiplier();
		...
		title = summon.isInvisible() ? "Invisible" : summon.getTitle();
