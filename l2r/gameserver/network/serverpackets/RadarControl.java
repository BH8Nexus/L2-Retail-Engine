...
public class RadarControl extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		if (_type == 2)
			// Original Message: Please open mini-map to see the location.
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.serverpackets.RadarControl.message1", activeChar));
