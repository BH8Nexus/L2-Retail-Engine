...
public enum NpcString
{
	...
	// Text: The match is automatically cancelled because you are too far from the admission manager.
	...
	// Text: Everyone, concentrate your attacks on $s1! Show the enemy your resolve!
	EVERYONE_CONCENTRATE_YOUR_ATTACKS_ON_S1_SHOW_THE_ENEMY_YOUR_RESOLVE(1300012),
	// Text: Attacking the enemy's reinforcements is necessary. Time to die!
	...
	// Text: Dear $s1... Think of this as my appreciation for the gil2r. Take this with you. There's nothing strange about it. It's just a bit of my capriciousness...
	DEAR_S1(1801195),
	...
	THIS_PLACE_IS_DANGEROUS_S1(1000513),
	...
	FURNACE_WILL_GO_OUT_WATCH_AND_SEE(60000),
	THERE_JUST_1_MINUTES_LEFT(60001),
	THERE_JUST_10_SECONDS_LEFT(60002),
	NOW_LIGHT_THE_FURNACE_FIRE(60003),
	TIME_IS_UP_AND_YOU_HAVE_FAILED(60004),
	OH_YOUVE_SUCCESSEDED(60005),
	AH_IS_THIS_FAILURE_BUT_IT_LOOKS_LIKE_I_CAN_KEEP_GOING(60006),
	AH_I_VE_FAILED_GOING_FURTHER_WILL_BE_DIFFICULT(60007),
	// Text: We love you.
	WE_LOVE_YOU(1800104),
	...
	// Text: Just back from their world tourΠ²Π‚Β¦put your hands together for the Fantasy Isle Circus!
	...
	MY_BRETHREN_WHO_ARE_STRONGER_THAN_ME_WILL_PUNISH_YOU(1911112),
	...
	IF_YOU_WISH_TO_SEE_HELL_I_WILL_GRANT_YOU_YOUR_WISH(1911118),
	HOW_COULD_I_LOSE_AGAINST_THESE_WORTHLESS_CREATURES(1911113),
	FOOLISH_CREATURES(1911114),
