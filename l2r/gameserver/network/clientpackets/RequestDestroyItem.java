...
import l2r.gameserver.dao.PetDataDAO;
...
public class RequestDestroyItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		Log.item(Log.Delete, this, activeChar, item, "HWID: " + activeChar.getHWID());
		...
		{
			PetDataDAO.getInstance().deletePet(item, activeChar);
		}
		...
		if (crystallize)
		{
			...
			// activeChar.getInventory().addItem(crystalId, crystalAmount, true,);
		}
		else
		{
