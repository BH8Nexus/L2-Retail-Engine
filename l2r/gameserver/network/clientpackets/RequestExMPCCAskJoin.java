...
public class RequestExMPCCAskJoin extends L2GameClientPacket
{
	...
	private void sendInvite(Player requestor, Player target)
	{
		...
		requestor.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestExMPCCAskJoin.message1", requestor).addString(target.getName())); // TODO [G1ta0] custom message
	}
}