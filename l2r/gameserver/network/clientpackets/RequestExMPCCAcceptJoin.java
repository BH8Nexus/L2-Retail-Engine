...
public class RequestExMPCCAcceptJoin extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		try
		{
			...
			{
				// CC can be created if there is a clan skill Clan Imperium
				boolean haveSkill = requestor.getSkillLevel(CommandChannel.CLAN_IMPERIUM_ID) > 0;
				boolean haveItem = false;
				// There is no skill, you will have to spend the item, we are looking for the Strategy Guide in the inventory
				if (!haveSkill)
				{
