...
public class AnswerTradeRequest extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			request.cancel();
			requestor.sendPacket(new SystemMessage2(SystemMsg.C1_HAS_DENIED_YOUR_REQUEST_TO_TRADE).addString(activeChar.getVisibleName(requestor)));
			return;
		}
		
		if (!requestor.canOverrideCond(PcCondOverride.ITEM_TRADE_CONDITIONS))
		{
