...
import l2r.gameserver.model.instances.ManorManagerInstance;
...
/**
 * Format: cdd[dd] c // id (0xC5) d // manor id d // seeds to buy [ d // seed id d // count ]
 */
public class RequestBuySeed extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!Config.ALT_GAME_KARMA_PLAYER_CAN_SHOP && (activeChar.getKarma() > 0) && !activeChar.canOverrideCond(PcCondOverride.CASTLE_CONDITIONS))
		{
			activeChar.sendActionFailed();
			return;
		}
		...
		if (!activeChar.canOverrideCond(PcCondOverride.CASTLE_CONDITIONS) && ((manor == null) || !activeChar.isInRange(manor, Creature.INTERACTION_DISTANCE)))
		{
			activeChar.sendActionFailed();
			return;
		}
