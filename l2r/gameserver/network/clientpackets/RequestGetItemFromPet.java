...
public class RequestGetItemFromPet extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((item.getCount() < _amount) || item.isEquipped())
		{
			activeChar.sendActionFailed();
			return;
		}
		...
		if (item.isHeroWeapon())
		{
			...
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestGetItemFromPet.message1", activeChar));
			activeChar.sendActionFailed();
			return;
		}
