...
public class RequestRecipeShopMakeDo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		try
		{
			...
			{
				_price -= tax;
				manufacturer.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestRecipeShopMakeDo.HavePaidTax", manufacturer).addNumber(tax));
			}
		...
		for (int i = 0; i < tryCount; i++)
		{
			...
			if (buyer.getClient().getBonusExpire() > (System.currentTimeMillis() / 1000L))
			{
