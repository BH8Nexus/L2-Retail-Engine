...
public class RequestExRemoveItemAttribute extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		int prevValue = itemToUnnchant.getAttributeElementValue(element, false);
		...
		Log.item(Log.AttributeRemove, activeChar, null, itemToUnnchant, "Element: " + element + " Val: " + prevValue);
	}
}