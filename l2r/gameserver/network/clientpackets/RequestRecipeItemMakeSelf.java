	...
	protected void runImpl()
	{
		...
		for (int i = 0; i < tryCount; i++)
		{
			...
			if (Rnd.chance(chance))
			{
				...
				/*
				 * if (itemId == recipeList.getFoundation()) activeChar.getCounters().foundationItemsMade++;
				 */
			}
		}
		...
		// if (success == 0)
		// {
		// activeChar.getCounters().CraftedRecipes++;
		// }
		// else
		// {
		// activeChar.getCounters().FailedCrafing++;
		// }
		// }
