...
public class RequestDropItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestDropItem.Disallowed", activeChar));
			return;
		}
		...
		if (item == null)
		{
			LOG.warn(activeChar.getName() + ":tried to drop an item that is not in the inventory ?!?:" + _objectId);
			activeChar.sendActionFailed();
			return;
		}
