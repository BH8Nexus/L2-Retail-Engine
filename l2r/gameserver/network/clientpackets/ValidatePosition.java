...
public class ValidatePosition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(activeChar.isTeleporting() || activeChar.isInObserverMode() || activeChar._inDeathCameraMode)
			return;
	...
	private void correctPosition(Player activeChar)
	{
		...
		Functions.sendDebugMessage(activeChar, "Server loc: " + activeChar.getLoc());
		Functions.sendDebugMessage(activeChar, "Correcting position...");
