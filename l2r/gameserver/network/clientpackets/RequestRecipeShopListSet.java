...
public class RequestRecipeShopListSet extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(System.currentTimeMillis() - manufacturer.getLastRequestRecipeShopListSetPacket() < Config.REQUESTRECIPESHOPLISTSETPACKETDELAY)
		{
			manufacturer.sendActionFailed();
			return;
		}
		manufacturer.setLastRequestRecipeShopListSetPacket();
