...
public class RequestActionUse extends L2GameClientPacket
{
	...
	/*
	 * type: 0 - action 1 - pet action 2 - pet skill 3 - social 4 - couple social transform: 0 Ð´Ð»Ñ� Ð»ÑŽÐ±Ñ‹Ñ… Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¾ 1 Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¾ Ð´Ð»Ñ� Ð½ÐµÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ñ… 2 Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð¾ Ð´Ð»Ñ� Ð²Ñ�ÐµÑ…
	 */
	public enum Action
	{
		// Ð”ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ð¿ÐµÑ€Ñ�Ð¾Ð½Ð°Ð¶ÐµÐ¹
		ACTION0(0, PLAYER_ACTION, 0, 1), // Ð¡ÐµÑ�Ñ‚ÑŒ/Ð²Ñ�Ñ‚Ð°Ñ‚ÑŒ
		ACTION1(1, PLAYER_ACTION, 0, 0), // Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ñ‚Ð¸Ð¿ Ð¿ÐµÑ€ÐµÐ´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ñ�, ÑˆÐ°Ð³/Ð±ÐµÐ³
		ACTION7(7, PLAYER_ACTION, 0, 1), // Next Target
		ACTION10(10, PLAYER_ACTION, 0, 1), // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ñ€Ð¾Ð´Ð°Ð¶Ð¸
		ACTION28(28, PLAYER_ACTION, 0, 1), // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¸
		ACTION37(37, PLAYER_ACTION, 0, 1), // Ð¡Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Common Craft
		ACTION38(38, PLAYER_ACTION, 0, 1), // Mount
		ACTION51(51, PLAYER_ACTION, 0, 1), // Ð¡Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Dwarven Craft
		ACTION61(61, PLAYER_ACTION, 0, 1), // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ñ€Ð¾Ð´Ð°Ð¶Ð¸ (Package)
		...
		// Ð”ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ð¿ÐµÑ‚Ð¾Ð²
		ACTION15(15, PET_ACTION, 0, 0), // Pet Follow
		ACTION16(16, PET_ACTION, 0, 0), // Ð�Ñ‚Ð°ÐºÐ° Ð¿ÐµÑ‚Ð¾Ð¼
		ACTION17(17, PET_ACTION, 0, 0), // ÐžÑ‚Ð¼ÐµÐ½Ð° Ð´ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ñƒ Ð¿ÐµÑ‚Ð°
		ACTION19(19, PET_ACTION, 0, 0), // ÐžÑ‚Ð·Ñ‹Ð² Ð¿ÐµÑ‚Ð°
		ACTION21(21, PET_ACTION, 0, 0), // Pet Follow
		ACTION22(22, PET_ACTION, 0, 0), // Ð�Ñ‚Ð°ÐºÐ° Ð¿ÐµÑ‚Ð¾Ð¼
		ACTION23(23, PET_ACTION, 0, 0), // ÐžÑ‚Ð¼ÐµÐ½Ð° Ð´ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ñƒ Ð¿ÐµÑ‚Ð°
		ACTION52(52, PET_ACTION, 0, 0), // ÐžÑ‚Ð·Ñ‹Ð² Ñ�Ð°Ð¼Ð¼Ð¾Ð½Ð°
		ACTION53(53, PET_ACTION, 0, 0), // ÐŸÐµÑ€ÐµÐ´Ð²Ð¸Ð½ÑƒÑ‚ÑŒ Ð¿ÐµÑ‚Ð° Ðº Ñ†ÐµÐ»Ð¸
		ACTION54(54, PET_ACTION, 0, 0), // ÐŸÐµÑ€ÐµÐ´Ð²Ð¸Ð½ÑƒÑ‚ÑŒ Ð¿ÐµÑ‚Ð° Ðº Ñ†ÐµÐ»Ð¸
		
		// Ð”ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ð¿ÐµÑ‚Ð¾Ð² Ñ�Ð¾ Ñ�ÐºÐ¸Ð»Ð»Ð°Ð¼Ð¸
		...
		ACTION1046(1046, PET_SKILL, 5585, 0), // Strider - Roar // TODO Ñ�ÐºÐ¸Ð»Ð» Ð½Ðµ Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°ÐµÑ‚Ñ�Ñ� Ð´Ð°Ð¶Ðµ Ð½Ð° 85 ÑƒÑ€Ð¾Ð²Ð½Ðµ, Ð²ÐµÑ€Ð¾Ñ�Ñ‚Ð½Ð¾ Ð½ÑƒÐ¶Ð½Ð¾ ÐºÐ¾Ñ€Ñ€ÐµÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾Ð»Ðµ type Ð² PetInfo Ð´Ð»Ñ� Ñ�Ñ‚Ñ€Ð°Ð¹Ð´ÐµÑ€Ð¾Ð²
		...
		// Ð¡Ð¾Ñ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð´ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ�
		...
		// ÐŸÐ°Ñ€Ð½Ñ‹Ðµ Ñ�Ð¾Ñ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð´ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ�
		...
		Action(int id, int type, int value, int transform)
		{
			this.id = id;
			this.type = type;
			this.value = value;
	...
	protected void runImpl()
	{
		...
		if(System.currentTimeMillis() - activeChar.getLastRequestActionUsePacket() < Config.REQUESTACTUIONUSEPACKETDELAY)
		{
		...
		if ((activeChar.getTransformation() != 0) && (action.transform > 0)) // TODO Ñ€Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ð´Ð»Ñ� Ð½ÐµÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ñ… Ñ‚Ñ€Ð°Ð½Ñ�Ñ„Ð¾Ñ€Ð¼
		{
			activeChar.sendActionFailed();
			return;
		}
		...
		if (action.type == SOCIAL_ACTION)
		{
			if (activeChar.isGM() && _shiftPressed) // Shift-pressed social action from GM will result in target doing it.
			{
				...
				{
					// Original Message: Target caused to use social action.
					activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message3", activeChar));
		...
		if (action.type == PET_SKILL)
		{
			if (validateSummon(pet, true))
			{
				...
				if (target !=null)
				{
					if (((action.id == 1039) || (action.id == 1040)) && (target.isDoor() || (target instanceof SiegeFlagInstance))) // Swoop Cannon (Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð°Ñ‚Ð°ÐºÐ¾Ð²Ð°Ñ‚ÑŒ Ð´Ð²ÐµÑ€Ð¸ Ð¸ Ñ„Ð»Ð°Ð³Ð¸)
					{
						activeChar.sendActionFailed();
						return;
					}
		...
		switch (action.id)
		{
			case 0: 
				...
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed sit/stand from GM will result in target doing it.
				{
					if ((activeChar.getTarget() != null) && activeChar.getTarget().isPlayer())
					{
						// Original Message: Target caused to sit/stand.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message4", activeChar));
						activeChar = (Player) activeChar.getTarget();
					}
				}
				...
				break;
			case 1: // Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ñ‚Ð¸Ð¿ Ð¿ÐµÑ€ÐµÐ´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ñ�, ÑˆÐ°Ð³/Ð±ÐµÐ³
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed run/walk from GM will result in target doing it.
				{
					...
					{
						// Original Message: Target caused to run/walk.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message5", activeChar));
			...
			case 7: // Next Target
				...
				break;
			case 10: // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ñ€Ð¾Ð´Ð°Ð¶Ð¸
			case 61: // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ñ€Ð¾Ð´Ð°Ð¶Ð¸ (Package)
			{
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed private store from GM will result in target doing it.
				{
					if ((activeChar.getTarget() != null) && activeChar.getTarget().isPlayer())
					{
						// Original Message: Target caused to use private store.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message6", activeChar));
						activeChar = (Player) activeChar.getTarget();
					}
				}
			...
			case 28: // Ð—Ð°Ð¿Ñ€Ð¾Ñ� Ð½Ð° Ñ�Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¿Ñ€Ð¸Ð²Ð°Ñ‚Ð½Ð¾Ð³Ð¾ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¸
			{
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed private store from GM will result in target doing it.
				{
					if ((activeChar.getTarget() != null) && activeChar.getTarget().isPlayer())
			...
			case 37: // Ð¡Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Dwarven Craft
			{
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed private manufacture from GM will result in target doing it.
				{
					if ((activeChar.getTarget() != null) && activeChar.getTarget().isPlayer())
					{
						// Original Message: Target caused to use dwarven manufacture.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message7", activeChar));
						activeChar = (Player) activeChar.getTarget();
					}
				}
			...
			case 51: // Ð¡Ð¾Ð·Ð´Ð°Ð½Ð¸Ðµ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð° Common Craft
			{
				if (activeChar.isGM() && _shiftPressed) // Shift-pressed common craft store from GM will result in target doing it.
				{
					if ((activeChar.getTarget() != null) && activeChar.getTarget().isPlayer())
					{
						// Original Message: Target caused to use common craft store.
						activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message8", activeChar));
						activeChar = (Player) activeChar.getTarget();
					}
				}
			...
			case 97: // Request Party Command Channel Info?
				...
				break;
			/*
			 * Disabled from retail like button, will be handled by voice command. case 65: // Bot Report Button if(Config.ENABLE_AUTO_HUNTING_REPORT) { if(activeChar.getTarget() instanceof Player) { Player reported = (Player) activeChar.getTarget();
			 * if(!AutoHuntingManager.getInstance().validateBot(reported, activeChar)) return; if(!AutoHuntingManager.getInstance().validateReport(activeChar)) return; try { AutoHuntingManager.getInstance().reportBot(reported, activeChar); } catch (Exception e) { e.printStackTrace(); } } else
			 * activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.BotReport1", activeChar)); } else activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.BotReport2", activeChar)); break;
			 */
			// Ð”ÐµÐ¹Ñ�Ñ‚Ð²Ð¸Ñ� Ñ� Ð¿ÐµÑ‚Ð°Ð¼Ð¸:
			
			case 15:
			case 21: // Follow 
				//if (pet != null && !pet.isAfraid())
				if(this.validateSummon(pet, true))
				{
...
//				}
			...
			case 38: // Mount
				...
				else if ((pet == null) || !pet.isMountable())
				{
					if (activeChar.isMounted())
					{
						if (activeChar.isFlying() && !activeChar.checkLandingState()) // Ð’Ð¸Ð²ÐµÑ€Ð½Ð°
						{
			...
			case 1001:
				break;
			default:
				// Original Message: Unhandled action type " + _actionId);
				activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestActionUse.message9", activeChar).addNumber(_actionId));
				_log.warn("Unhandled action type " + _actionId + " by player " + activeChar.getName());
		}
		activeChar.sendActionFailed();
	}
	...
	private boolean validateSummon(Summon summon, boolean checkPet)
	{
		...
		if (summon != null && checkPet && summon.isPet() || summon.isSummon())
		{
			if (summon.isPet() && ((PetInstance)summon).isUncontrollable())
			{
				activeChar.sendPacket(SystemMsg.WHEN_YOUR_PETS_HUNGER_GAUGE_IS_AT_0_YOU_CANNOT_USE_YOUR_PET);
				return false;
			}
			else
			{
