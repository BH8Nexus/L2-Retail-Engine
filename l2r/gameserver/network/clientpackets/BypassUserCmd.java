...
public class BypassUserCmd extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(handler == null)
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.BypassUserCmd.S1NotImplemented", activeChar).addString(String.valueOf(_command)));
		else
