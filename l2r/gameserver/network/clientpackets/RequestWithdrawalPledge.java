...
public class RequestWithdrawalPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(System.currentTimeMillis() - activeChar.getLastRequestWithdrawalPledgePacket() < Config.REQUESTWITHDRAWALPLEDGEPACKETDELAY)
		{
		...
		{
			// Original Message: The clan leader may not be dismissed.
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestWithdrawalPledge.CannotDismissClanLeader", activeChar));
			return;
		}
