...
import l2r.gameserver.model.matching.CCMatchingRoom;
import l2r.gameserver.network.serverpackets.ListPartyWaiting;
...
public class RequestPartyMatchConfig extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((party != null) && (channel != null) && (channel.getLeader() == player))
		{
