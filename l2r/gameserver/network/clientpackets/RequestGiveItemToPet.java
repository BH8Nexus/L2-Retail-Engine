...
public class RequestGiveItemToPet extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			// Original Message: You cannot trade items to pet with karma.
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestGiveItemToPet.message1", activeChar));
			return;
		}
		...
		{
			// Original Message: The pet can not carry weapons hero!
			activeChar.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestGiveItemToPet.message2", activeChar));
			activeChar.sendActionFailed();
			return;
		}
