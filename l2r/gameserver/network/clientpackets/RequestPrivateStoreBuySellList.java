		...
		finally
		{
			try
			{
				...
				for (TradeItem si : sellList)
				{
					...
					Log.item(Log.PrivateStoreBuy, seller, buyer, item, "Total Cost: " + totalCost + " Packet Hash: " + hashCode());
				...
				{
					totalCost -= tax;
					seller.sendMessage(new CustomMessage("l2r.gameserver.network.clientpackets.RequestPrivateStoreBuySellList.HavePaidTax", seller).addNumber(tax));
				}
