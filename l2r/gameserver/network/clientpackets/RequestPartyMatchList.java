...
import l2r.gameserver.model.matching.PartyMatchingRoom;
...
public class RequestPartyMatchList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(System.currentTimeMillis() - player.getLastRequestPartyMatchListPacket() < Config.REQUESTPARTYMATCHLISTPACKETDELAY)
		{
			player.sendActionFailed();
			return;
		}
		player.setLastRequestPartyMatchListPacket();
