...
import l2r.commons.net.nio.impl.IPacketHandler;
...
public final class GamePacketHandler implements IPacketHandler<GameClient>, IClientFactory<GameClient>, IMMOExecutor<GameClient>
{
	...
	public ReceivablePacket<GameClient> handlePacket(ByteBuffer buf, GameClient client)
	{
		...
		if ((client == null) || !client.isConnected() || !buf.hasRemaining())
		{
			return null;
		}
						...
						case 0xd0:
							...
							switch (id3)
							{
								...
								case 0x83:
									...
									{
										/*
										 * TODO: case 0x01: //msg = new RequestExAgitInitialize chd 0x01 break; case 0x02: //msg = new RequestExAgitDetailInfo chdcd 0x02 break; case 0x03: //msg = new RequestExMyAgitState chd 0x03 break; case 0x04: //msg = new RequestExRegisterAgitForBidStep1 chd
										 * 0x04 break; case 0x05: //msg = new RequestExRegisterAgitForBidStep2 chddQd 0x05 //msg = new RequestExRegisterAgitForBidStep3 chddQd 0x05 -no error? 0x05 break; case 0x07: //msg = new RequestExConfirmCancelRegisteringAgit chd 0x07 break; case 0x08: //msg =
										 * new RequestExProceedCancelRegisteringAgit chd 0x08 break; case 0x09: //msg = new RequestExConfirmCancelAgitBid chdd 0x09 break; case 0x10: //msg = new RequestExReBid chdd 0x10 break; case 0x11: //msg = new RequestExAgitListForLot chd 0x11 break; case 0x12:
										 * //msg = new RequestExApplyForAgitLotStep1 chdc 0x12 break; case 0x13: //msg = new RequestExApplyForAgitLotStep2 chdc 0x13 break; case 0x14: //msg = new RequestExAgitListForBid chdd 0x14 break; case 0x0D: //msg = new RequestExApplyForBidStep1 chdd 0x0D
										 * break; case 0x0E: //msg = new RequestExApplyForBidStep2 chddQ 0x0E break; case 0x0F: //msg = new RequestExApplyForBidStep3 chddQ 0x0F break; case 0x09: //msg = new RequestExConfirmCancelAgitLot chdc 0x09 break; case 0x0A: //msg = new
										 * RequestExProceedCancelAgitLot chdc 0x0A break; case 0x0A: //msg = new RequestExProceedCancelAgitBid chdd 0x0A break;
										 */
									}
									break;
								case 0x84:
