...
public class ChangePasswordResponse extends ReceivablePacket
{
	...
	protected void runImpl()
	{
		...
		if (changed)
		{
			Functions.show(new CustomMessage("l2r.gameserver.handler.voicecommands.impl.Password.ResultTrue", activeChar), activeChar);
		}
		else
		{
			Functions.show(new CustomMessage("l2r.gameserver.handler.voicecommands.impl.Password.ResultFalse", activeChar), activeChar);
		}
	}
}