...
public class Strings
{
	...
	public static void reload()
	{
		try
		{
			String[] pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/xml/translit.txt")).split("\n");
			...
			pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/xml/translit_back.txt")).split("\n");
			...
			pairs = FileUtils.readFileToString(new File(Config.DATAPACK_ROOT, "data/xml/transcode.txt")).split("\n");
