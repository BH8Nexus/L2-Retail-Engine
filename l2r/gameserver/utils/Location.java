...
//		super(x, y, z);
//		h = heading;
//		r = ReflectionManager.DEFAULT_ID;
//	}
//	
//	public Location(int x, int y, int z, int heading, int reflectionId)
//	{
//		super(x, y, z);
//		h = heading;
//		r = reflectionId;
...
//	public Location(GameObject obj)
//	{
//		this(obj.getX(), obj.getY(), obj.getZ(), obj.getHeading(), obj.getReflectionId());
//	}
//	
//	@Override
//	public Location changeX(int xDiff)
//	{
//		x += xDiff;
//		return this;
//	}
//	
//	@Override
//	public Location changeY(int yDiff)
//	{
//		y += yDiff;
//		return this;
//	}
...
//	}
//	
//	public Location setH(int heading)
//	{
//		h = heading;
//		return this;
//	}
...
//	public Location setR(Reflection reflection)
//	{
//		r = reflection != null ? reflection.getId() : ReflectionManager.DEFAULT_ID;
//		return this;
//	}
//	
//	public Location setR(GameObject obj)
...
//	}
//	
//	public Location set(int x, int y, int z, int heading)
//	{
//		set(x, y, z);
//		h = heading;
//		return this;
//	}
//	
//	public Location set(int x, int y, int z, int heading, int reflectionId)
//	{
//		set(x, y, z);
//		h = heading;
//		r = reflectionId;
...
//	public Location geo2world()
//	{
//		// Ñ€Ð°Ð·Ð¼ÐµÑ€ Ð¾Ð´Ð½Ð¾Ð³Ð¾ Ð±Ð»Ð¾ÐºÐ° 16*16 Ñ‚Ð¾Ñ‡ÐµÐº, +8*+8 Ñ�Ñ‚Ð¾ ÐµÐ³Ð¾ Ñ�Ñ€ÐµÐ´Ð¸Ð½Ð°
//		x = (x << 4) + World.MAP_MIN_X + 8;
//		y = (y << 4) + World.MAP_MIN_Y + 8;
//		return this;
//	}
...
//	
//	/**
//	 * ÐŸÐ°Ñ€Ñ�Ð¸Ñ‚ Location Ð¸Ð· Ñ�Ñ‚Ñ€Ð¾ÐºÐ¸, Ð³Ð´Ðµ ÐºÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ñ€Ð°Ð·Ð´ÐµÐ»ÐµÐ½Ñ‹ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð°Ð¼Ð¸ Ð¸Ð»Ð¸ Ð·Ð°Ð¿Ñ�Ñ‚Ñ‹Ð¼Ð¸
//	 */
//	public static Location parseLoc(String s) throws IllegalArgumentException
//	{
//		String[] xyzh = s.split("[\\s,;]+");
...
//		int y = Integer.parseInt(element.attributeValue("y"));
//		int z = Integer.parseInt(element.attributeValue("z"));
//		int heading = element.attributeValue("h") == null ? 0 : Integer.parseInt(element.attributeValue("h"));
//		int reflectionId = element.attributeValue("r") == null ? ReflectionManager.DEFAULT_ID : Integer.parseInt(element.attributeValue("r"));
//		return new Location(x, y, z, heading, reflectionId);
//	}
//	
//	/**
//	 * Find a stable point in front of the object obj1 to spawn object obj2, with a set heading. Ignores Reflections.
//	 * @param obj
//	 * @param obj2
//	 * @param radiusmin
//	 * @param radiusmax
...
//		if (!obj.equals(obj2))
//		{
//			double angle = Location.calculateAngleFrom(obj, obj2);
//			minangle = (int) angle - 45;
//			maxangle = (int) angle + 45;
//		}
//		
...
//				if (!obj.equals(obj2))
//				{
//					pos.h = Location.getHeadingTo(pos, obj2.getLoc());
//				}
//				else
//				{
//					pos.h = obj.getHeading();
...
//	
//	/**
//	 * Ð�Ð°Ð¹Ñ‚Ð¸ Ñ‚Ð¾Ñ‡ÐºÑƒ Ð² Ð¿Ñ€ÐµÐ´ÐµÐ»Ð°Ñ… Ð´Ð¾Ñ�Ñ�Ð³Ð°ÐµÐ¼Ð¾Ñ�Ñ‚Ð¸ Ð¾Ñ‚ Ð½Ð°Ñ‡Ð°Ð»ÑŒÐ½Ð¾Ð¹<br>
//	 * Find the point within reach of the initial
//	 * @param x
//	 * @param y
//	 * @param z
//	 * @param radiusmin
...
//		for (int i = 0; i < 100; i++)
//		{
//			pos = Location.coordsRandomize(x, y, z, 0, ReflectionManager.DEFAULT_ID, radiusmin, radiusmax);
//			tempz = GeoEngine.getHeight(pos.x, pos.y, pos.z, geoIndex);
//			if (GeoEngine.canMoveToCoord(x, y, z, pos.x, pos.y, tempz, geoIndex) && GeoEngine.canMoveToCoord(pos.x, pos.y, tempz, x, y, z, geoIndex))
//			{
//				pos.z = tempz;
...
//	}
//	
//	public Location findAroundPosition(int radiusmin, int radiusmax)
//	{
//		Location pos;
//		int tempz;
//		Reflection reflection = ReflectionManager.getInstance().get(r);
//		if (reflection == null)
//		{
//			reflection = ReflectionManager.DEFAULT;
//		}
...
//	}
//	
//	public Location findAroundPosition(int radius)
//	{
//		return findAroundPosition(0, radius);
//	}
//	
//	public static Location findAroundPosition(Location loc, int radius, int geoIndex)
//	{
...
//	public static Location findAroundPosition(GameObject obj, int radiusmin, int radiusmax)
//	{
//		return obj.getLoc().findAroundPosition(radiusmin, radiusmax);
//	}
//	
//	public static Location findAroundPosition(GameObject obj, int radius)
//	{
...
//	
//	/**
//	 * Ð�Ð°Ð¹Ñ‚Ð¸ Ñ�Ñ‚Ð°Ð±Ð¸Ð»ÑŒÐ½ÑƒÑŽ Ñ‚Ð¾Ñ‡ÐºÑƒ Ð² Ð¿Ñ€ÐµÐ´ÐµÐ»Ð°Ñ… Ñ€Ð°Ð´Ð¸ÑƒÑ�Ð° Ð¾Ñ‚ Ð½Ð°Ñ‡Ð°Ð»ÑŒÐ½Ð¾Ð¹<br>
//	 * Find a stable point within the radius of the initial
//	 * @param x
//	 * @param y
//	 * @param z
//	 * @param radiusmin
...
//				radiusmin = 0;
//			}
//			Location pos = coordsRandomize(x, y, z, ReflectionManager.DEFAULT_ID, radiusmin, radiusmax - i);
...
//	}
//	
//	public Location findPointToStay(int radiusmin, int radiusmax)
//	{
//		Location pos;
//		int tempz;
//		Reflection ref = ReflectionManager.getInstance().get(r);
//		if (ref == null)
//		{
//			ref = ReflectionManager.DEFAULT;
//		}
//		
//		int geoIndex = ref.getGeoIndex();
//		for (int i = 0; i < 100; i++)
//		{
//			pos = Location.coordsRandomize(x, y, z, 0, ReflectionManager.DEFAULT_ID, radiusmin, radiusmax);
//			tempz = GeoEngine.getHeight(pos.x, pos.y, pos.z, geoIndex);
...
//	}
//	
//	public Location findPointToStay(int radius)
//	{
//		return findPointToStay(0, radius);
//	}
//	
//	public static Location findPointToStay(GameObject obj, int radiusmin, int radiusmax)
//	{
//		return obj.getLoc().findPointToStay(radiusmin, radiusmax);
//	}
//	
//	public static Location findPointToStay(GameObject obj, int radius)
//	{
...
//	 * @param radiusmin : Random's min
//	 * @param radiusmax : Random;s max
//	 * @return Location (rndX, rndY, z, heading, reflectionId)
//	 */
//	public static Location coordsRandomize(int x, int y, int z, int heading, int reflectionId, int radiusmin, int radiusmax)
//	{
//		return new Location(x, y, z, heading, reflectionId).coordsRandomize(radiusmin, radiusmax);
//	}
//	
//	public static Location coordsRandomize(int x, int y, int z, int heading, int radiusmin, int radiusmax)
//	{
