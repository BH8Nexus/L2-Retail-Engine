...
public class AutoHuntingPunish
{
	...
	/**
	 * Returns the time (in millis) when the player punish started
	 * @return long
	 */
	...
	/**
	 * Returns the duration (in seconds) of the applied punish
	 * @return int
	 */
	...
	/**
	 * @return true if the player punishment has expired
	 */
