package l2r.gameserver.taskmanager.actionrunner;
...
import l2r.gameserver.taskmanager.actionrunner.tasks.AutomaticTask;
import l2r.gameserver.taskmanager.actionrunner.tasks.CheckOfflineShopsTask;
import l2r.gameserver.taskmanager.actionrunner.tasks.DeleteExpiredMailTask;
import l2r.gameserver.taskmanager.actionrunner.tasks.DeleteExpiredVarsTask;
import l2r.gameserver.taskmanager.actionrunner.tasks.DualboxOutsidePeaceTask;
import l2r.gameserver.taskmanager.actionrunner.tasks.OlympiadSaveTask;
...
public class ActionRunner extends LoggerObject
{
	...
	private ActionRunner()
	{
		...
		{
			register(new CheckOfflineShopsTask());
		}
		register(new DualboxOutsidePeaceTask());
	}
