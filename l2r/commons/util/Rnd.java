/*
 * Copyright Β© 2004-2020 L2J Server
 *
...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see l2r.commons.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link l2r.commons.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see l2r.commons.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see l2r.commons.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see l2r.commons.util.Rnd#get(int n)
	 */
	...
	{
		return chance < 1 ? false : chance > 99 ? true : (rnd.get(99) + 1) <= chance;
	}
	...
	public static boolean getRnd(double chance)
	{
		double arg1 = _rnd.nextInt(10);
		double arg2 = _rnd.nextInt(10);
		return (((arg1 / 10) + (arg2 / 100)) * 1000000) <= chance;
	}
}