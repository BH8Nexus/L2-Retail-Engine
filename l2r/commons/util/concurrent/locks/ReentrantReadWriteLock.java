package l2r.commons.util.concurrent.locks;

import java.util.concurrent.atomic.AtomicIntegerFieldUpdater;

/**
 * Класс обеспечивающий блокировку с повторным входом и разделением на чтение/запись. Упрощенный аналог {@link java.util.concurrent.locks.ReentrantReadWriteLock} Потребляет меньше памяти, менее производителен.
 * <p>
 * Возможность повторого входа также обеспечивает понижение блокировки с записи на чтение, для этого необходимо удерживая блокировку на запись, получить блокировку на чтение и освободить блокировку на запись. Следует помнить, что повышение блокировки на запись, при удержании блокировки на чтение,
 * невозможно.
 * </p>
 * @author G1ta0
 */
