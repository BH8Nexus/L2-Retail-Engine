...
//		/**
//		 * Builds the ValueMatcher.
//		 * @param integers An ArrayList<Integer> of Integer elements, one for every value accepted by the matcher. The match() method will return true only if its parameter will be one of this list.
//		 */
//		public IntArrayValueMatcher(List<Integer> integers)
//		{
//			int size = integers.size();
...
//		/**
//		 * Builds the ValueMatcher.
//		 * @param integers An ArrayList<Integer> of Integer elements, one for every value accepted by the matcher. The match() method will return true only if its parameter will be one of this list or the last-day-of-month setting applies.
//		 */
//		public DayOfMonthValueMatcher(List<Integer> integers)
//		{
//			super(integers);
