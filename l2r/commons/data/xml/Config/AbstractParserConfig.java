...
import l2r.commons.data.xml.helpers.SimpleDTDEntityResolver;
import l2r.commons.logging.LoggerObject;

/**
 * Author: VISTALL Date: 18:35/30.11.2010
 */
public abstract class AbstractParserConfig<H extends AbstractHolderConfig> extends LoggerObject
{
	...
	protected AbstractParserConfig(H holder)
	{
		_holder = holder;
		_reader = new SAXReader();
		_reader.setValidation(true);
		_reader.setErrorHandler(new ErrorHandlerImplConfig(this));
	}
