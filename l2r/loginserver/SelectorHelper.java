...
public class SelectorHelper extends IPv4Filter implements IMMOExecutor<L2LoginClient>, IClientFactory<L2LoginClient>
{
	@Override
	...
	{
		return super.accept(sc) && !IpBanManager.getInstance().isIpBanned(sc.socket().getInetAddress().getHostAddress());
	}
}