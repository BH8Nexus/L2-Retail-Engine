...
import l2r.loginserver.ThreadPoolManager;
import l2r.loginserver.gameservercon.lspackets.PingRequest;
...
public class GameServerConnection
{
	...
	/**
	 * Ping system: ÐŸÐ¾Ñ�Ð»Ðµ Ð°Ð²Ñ‚Ð¾Ñ€Ð¸Ð·Ð°Ñ†Ð¸Ð¸ Ð¸Ð³Ñ€Ð²Ð¾Ð³Ð¾ Ñ�ÐµÑ€Ð²ÐµÑ€Ð° Ð·Ð°Ð¿ÑƒÑ�ÐºÐ°ÐµÑ‚Ñ�Ñ� PingTask Ñ� Config.GAME_SERVER_PING_DELAY - Ð¾Ð½ Ð¿Ð¾Ñ�Ñ‹Ð»Ð°ÐµÑ‚ Ð¿Ð°ÐºÐµÑ‚ Ð¸ Ð·Ð°Ð¿ÑƒÑ�ÐºÐ°ÐµÑ‚ Ñ‚Ð°ÐºÑ� PingCheckTask - ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð¶Ð´ÐµÑ‚ Ð¾Ñ‚Ð²ÐµÑ‚ Ð¾Ð½ Ð“Ð¡, ÐµÑ�Ð»Ð¸ Ð¾Ñ‚Ð²ÐµÑ‚ Ð½ÐµÐ¿Ñ€Ñ‹Ð±Ñ‹Ð», Ð“Ð¡ ÑƒÐ¼ÐµÑ€, Ð¸ Ð¿Ñ€Ð¾ Ñ�Ñ‚Ð¾ Ð±ÑƒÐ´ÐµÑ‚ Ð½Ð°Ð¿Ð¸Ñ�Ð°Ð½Ð¾ Ð² ÐºÐ¾Ð½Ñ�Ð¾Ð»ÑŒ
	 */
	...
	{
		readBuffer = ByteBuffer.allocate(64 * 1024).order(ByteOrder.LITTLE_ENDIAN);
